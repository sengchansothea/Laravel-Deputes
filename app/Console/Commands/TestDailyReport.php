...
class TestDailyReport extends Command
{
     ...
     * @var string
     */
    protected $signature = 'report:test-log';
     ...
     * @var string
     */
    protected $description = 'This is a test command to log a sample message for testing!';
    ...
    {
        Log::info("🧪 Test command 'report:test-log' executed at " . now());
        $this->info("Test log message written to laravel.log");
