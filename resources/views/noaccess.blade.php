...
<head>
    ...
    <meta name="title" content="SICMS" />
    <meta name="keywords" content="SICMS" />
    <meta name="description" content="SICMS" />

    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="SICMS - សូមស្វាគមន៍មកកាន់ប្រព័ន្ធ របបស្វ័យប្រកាសអធិការកិច្ចការងារតាមប្រព័ន្ធស្វ័យប្រវត្តិកម្ម">
    <meta name="keywords" content="SICMS - សូមស្វាគមន៍មកកាន់ប្រព័ន្ធ របបស្វ័យប្រកាសអធិការកិច្ចការងារតាមប្រព័ន្ធស្វ័យប្រវត្តិកម្ម">
...
<div class="page-wrapper">
    ...
    <div class="error-wrapper">
        <div class="container"><img class="img-100" src="{{ rurl('assets/images/other-images/sad.png') }}" alt="">
            ...
            <div><a class="btn btn-success-gradien btn-lg" href="{{ url('/') }}">BACK TO HOME PAGE</a></div>
        </div>
    </div>
    <!-- error-403 end-->
</div>
