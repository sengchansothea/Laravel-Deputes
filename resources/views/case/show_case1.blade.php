@php
    ...
    $hasFullAccess = $adata['allowAccess'] || in_array($userOfficerID, $caseOfficerIDs) || ($userOfficerID == $entryUserID);
                        ...
                        <div class="card-block">
                            <div class="row">
                                <div class="form-group col-sm-4 mt-3">
                                    ...
                                    <input type="text" value="{{ $row->caseType->case_desc }}" class="form-control" disabled />
                                </div>
                                @if(!empty($caseDisputant->phone_number2))
                                    <div class="form-group col-sm-3 mt-3">
                                        <label class="mb-2">ឈ្មោះកម្មករនិយោជិត</label>
                                        <input type="text" value="{{ $disputant->name }} {{ $disputant->name_latin }}" class="form-control" disabled />
                                    </div>
                                    @php
                                    ...
                                    <div class="form-group col-sm-2 mt-3">
                                        ...
                                        <input type="text" value="{{ $caseDisputant->phone_number }}" class="form-control" disabled />
                                    </div>
                                    <div class="form-group col-sm-2 mt-3">
                                        <label class="mb-2">លេខទូរស័ព្ទ (ខ្សែទី២)</label>
                                        <input type="text" value="{{ $caseDisputant->phone_number2 }}" class="form-control" disabled />
                                    </div>
                                @else
                                    @if(!empty($disputant))
                                    <div class="form-group col-sm-4 mt-3">
                            ...
                            <div class="row">
                                @if(!empty($caseCompany->log5_company_phone_number2))
                                    <div class="form-group col-sm-8 mt-3">
                                        ...
                                        <input type="text" name="company_name_khmer" id="company_name_khmer" value="{{ $company->company_name_khmer }} {{ $company->company_name_latin }}" class="form-control" disabled />
                                    </div>
                                    <div class="form-group col-sm-2 mt-3">
                                        <label class="mb-2">លេខទូរស័ព្ទ (ខ្សែទី១)</label>
                                        <input type="text" value="@if(isset($caseCompany->log5_company_phone_number)) {{ $caseCompany->log5_company_phone_number }} @endif" class="form-control" disabled />
                                    </div>
                                    <div class="form-group col-sm-2 mt-3">
                                        <label class="mb-2">លេខទូរស័ព្ទ (ខ្សែទី២)</label>
                                        <input type="text" value="{{ $caseCompany->log5_company_phone_number2 }}" class="form-control" disabled />
                                    </div>
                                @else
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6 mt-3">
                                    <label for="case_type_id" class="fw-bold text-danger">***ដែនការិយាល័យទី{{ number2KhmerNumber($adata['domainID']) }}***</label>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6 mt-3">
                                    ...
                                    <label class="form-label fw-bold text-danger">{{ $entryUser->k_fullname }} @if(!empty($entryUser->officerRole))<span class="blue fw-bold">({{ $entryUser->officerRole->officer_role }})</span>@endif</label>

                                </div>
                                <div class="form-group col-sm-4 mt-3">
                                    {!! showSelect('in_out_domain',array(1 =>"ក្នុងដែនការិយាល័យ", 2 => "ក្រៅដែនការិយាល័យ"), old('in_out_domain',$inOrOutDomain), " select2", "onchange='this.form.submit()'", "", "required") !!}
                                </div>
                            </div>
                            </form>
                            <br>
                            <table class="table text-hanuman-18">
                                    ...
                                    <td>
                                        ...
                                        <div class="row mt-2">
                                            <div class="form-group col-sm-4">
                                                @if($hasFullAccess)
                                                <a class="btn btn-success custom form-control fw-bold" href="{{ url('cases/'.$row->id.'/edit') }}" title="កែប្រែពាក្យបណ្តឹង" target="_blank">កែសម្រួលពាក្យបណ្ដឹង</a>
                                                @endif
                                            </div>
                                            <div class="form-group col-sm-4"></div>
                                            <div class="form-group col-sm-4 text-end">
                                                <a class="btn btn-info custom form-control fw-bold" href="{{ url('export/word/case/'.$row->id) }}" title="ទាញយកពាក្យបណ្ដឹង" target="_blank">ទាញយកពាក្យបណ្ដឹង</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        @php
                                        if($hasFullAccess){
                                            $caseFile = showFile(1, $row->case_file, pathToDeleteFile('case_doc/form1/'.$caseYear."/"), "delete", "tbl_case", "id", $row->id,  "case_file", "", "");
                                            if($caseFile){
                                                echo $caseFile;
                                                ...
                                                echo '<a href="'.url('uploads/all/1/'.$row->id.'/'.$row->id).'" class="btn btn-success form-control mt-2 fw-bold">'."Upload លិខិត</a>";
                                            }
                                        }
                                        @endphp
                                    </td>
                                ...
                                <tr>
                                    ...
                                    @php
                                        $officerName ="";
                                        $select = showSelect('officer_id', $adata['caseOfficerList'], old('officer_id'), " select2", "", "", "required");
                                        $button = '<button type="submit" class="btn btn-success form-control fw-bold">បញ្ជូន</button>';
                                        $btnChangeOfficer = '<button id="btnShowSelectOfficer" value="0" type="button" class="btn btn-success form-control fw-bold">កំណត់ ឬផ្លាស់ប្តូរ</button>';
...
{{--                                            {!! nbs() !!}<label class="form-label text-info fw-bold">លេខាកត់ត្រា:</label>--}}
{{--                                            <span class="red fw-bold">--}}
{{--                                                    @if(!empty($lastNoter))--}}
{{--                                                    {{ $lastNoter->officer->officer_name_khmer }}--}}
{{--                                                @endif--}}
{{--                                                </span>--}}
{{--                                        </div>--}}
{{--                                    </td>--}}
                                    ...
                                    <td>
                                        ...
                                        if($hasFullAccess){
                                            if($invitationEmployee['invitation_id'] > 0){
                                                $showFile = showFile(1, $invitationEmployee['invitation_file'], pathToDeleteFile('invitation/'.$caseYear."/"), "delete", "tbl_case_invitation", "id", $invitationEmployee['invitation_id'],  "invitation_file", "");
                                                if($showFile){
                                                    echo $showFile;
                                                }
                                                else{
//                                                        echo '<button id="uploadButtonInvitationEmployee" class="btn btn-success form-control uploadButton" value="'.$invitationEmployee['invitation_id'].'" data-title="Upload លិខិតអញ្ជើញដែលមានចុះហត្ថលេខាទទួល" data-url="'.url('invitation/upload/file').'">Upload លិខិត</button>';
                                                    echo '<a href="'.url('uploads/all/3/'.$row->id.'/'.$invitationEmployee['invitation_id']).'" class="btn btn-success form-control fw-bold">'."Upload លិខិត</a>";
                                                }
                                            }
                                        }
                                        @endphp
                                        ...
                                        @if(count($row->invitationDisputant->nextTime) > 0)
                                            @foreach($row->invitationDisputant->nextTime as $next)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            <div class="form-group col-sm-12 fw-bold">
                                                                <span class="text-info"><span class="blue">[{{ $next->status->status_name }}]</span>
                                                    ...
                                                    <td>
                                                    @php
                                                        $showFile = showFile(1, $next->letter, pathToDeleteFile('invitation/next/'.$caseYear."/"), "delete", "tbl_case_invitation_next_time", "id", $next->id,  "letter", "");
                                                        if($showFile){
                                                            echo $showFile;
                                                        }
                                                        else{
                                                            echo '<a href="'.url('uploads/all/33/'.$row->id.'/'.$next->id).'" class="btn btn-success form-control fw-bold">'."Upload លិខិត</a>";
                                                        }
                                                    @endphp
                                                    </td>
                                                    <td></td>
                                    ...
                                    <td>
                                        ...
                                        if($hasFullAccess){
                                            if($showCaseLog34['log34_id'] > 0){
                                                $showFile = showFile(1, $showCaseLog34['log_file'], pathToDeleteFile('case_doc/log34/'.$caseYear."/"), "delete", "tbl_case_log34", "id", $showCaseLog34['log34_id'],  "log_file", "");
                                                if($showFile){
                                                    echo $showFile;
                                                }
                                                else{
                                                    ...
                                                    echo '<a href="'.url('uploads/all/4/'.$row->id.'/'.$showCaseLog34['log34_id']).'" class="btn btn-success form-control fw-bold">'."Upload កំណត់ហេតុ</a>";
                                                }
                                            }
                                        }
                                        @endphp
                                    ...
                                    <td>
                                        ...
                                        if($hasFullAccess){
                                            if($invitationCompany['invitation_id'] > 0){
                                                $showFile = showFile(1, $invitationCompany['invitation_file'], pathToDeleteFile('invitation/'.$caseYear."/"), "delete", "tbl_case_invitation", "id", $invitationCompany['invitation_id'],  "invitation_file", "");
                                                if($showFile){
                                                    echo $showFile;
                                                }
                                                else{
                                                    echo '<a href="'.url('uploads/all/5/'.$row->id.'/'.$invitationCompany['invitation_id']).'" class="btn btn-success form-control fw-bold">'."Upload លិខិត</a>";
                                                }
                                            }
                                        }
                                        @endphp
                                        ...
                                        @foreach($row->invitationCompany->nextTime as $next)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="form-group col-sm-12 fw-bold">
                                                            <span class="text-info"><span class="pink">[{{ $next->status->status_name }}]</span>
                                                                ជួបលើកក្រោយថ្ងៃទី <span class="text-danger">{{ date2Display($next->next_date) }}</span>
                                                                ម៉ោង <span class="text-danger">{{ $next->next_time }}</span>
                                                                មូលហេតុ <span class="text-danger">{{ $next->reason }}</span>
                                                            </span>
                                                ...
                                                <td>
                                                    ...
                                                    if($hasFullAccess){
                                                        ...
                                                        if($showFile){
                                                            ...
                                                            echo '<a href="'.url('uploads/all/55/'.$row->id.'/'.$next->id).'" class="btn btn-success form-control fw-bold">'."Upload លិខិត</a>";
                                                        }
                                                    }
                                                    @endphp
                                                </td>
                                    ...
                                    <td>
                                        ...
                                        if($hasFullAccess){
                                            if($showCaseLog5['log5_id'] > 0){
                                                $showFile = showFile(1, $showCaseLog5['log_file'], pathToDeleteFile('case_doc/log5/'.$caseYear."/"), "delete", "tbl_case_log5", "id", $showCaseLog5['log5_id'],  "log_file", "");
                                                if($showFile){
                                                    echo $showFile;
                                                }
                                                else{
                                                    echo '<a href="'.url('uploads/all/6/'.$row->id.'/'.$showCaseLog5['log5_id']).'" class="btn btn-success form-control fw-bold">'."Upload កំណត់ហេតុ</a>";
                                                }
                                            }
                                        }
                                        @endphp
                                ...
                                @if($invitationBoth['invitation_id1'] > 0)
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                            if($hasFullAccess){
                                                $showFile = showFile(1, $invitationBoth['invitation_file1'], pathToDeleteFile('invitation/'.$caseYear."/"), "delete", "tbl_case_invitation", "id", $invitationBoth['invitation_id1'],  "invitation_file", "");
                                                if($showFile){
                                                    echo $showFile;
                                                }
                                                else{
                                                    echo '<a href="'.url('uploads/all/7/'.$row->id.'/'.$invitationBoth['invitation_id1']).'" class="btn btn-success form-control fw-bold">'."Upload លិខិត</a>";
                                                }
                                            }
                                            @endphp
                                        </td>
                                ...
                                @if($invitationBoth['invitation_id2'] > 0)
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                            if($hasFullAccess){
                                                $showFile = showFile(1, $invitationBoth['invitation_file2'], pathToDeleteFile('invitation/'.$caseYear."/"), "delete", "tbl_case_invitation", "id", $invitationBoth['invitation_id2'],  "invitation_file", "");
                                                if($showFile){
                                                    echo $showFile;
                                                }
                                                else{
                                                    echo '<a href="'.url('uploads/all/7/'.$row->id.'/'.$invitationBoth['invitation_id2']).'" class="btn btn-success form-control fw-bold">'."Upload លិខិត</a>";
                                                }
                                            }
                                            @endphp
                                        </td>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="form-group col-sm-12 text-info fw-bold">
                                                            <span class="blue">*ដើមចោទ [{{ $next->status->status_name }}]</span>
                                                            ជួបលើកក្រោយថ្ងៃទី <span class="text-danger">{{ date2Display($next->next_date) }}</span>
                                                            ម៉ោង <span class="text-danger">{{ $next->next_time }}</span><br/>
                                                            មូលហេតុ <span class="text-danger">{{ $next->reason }}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                    ...
                                                    if($hasFullAccess){
                                                        ...
                                                        if($showFile){
                                                            echo $showFile;
                                                             ...
                                                             echo '<a href="'.url('uploads/all/77/'.$row->id.'/'.$next->id).'" class="btn btn-success form-control fw-bold">'."Upload លិខិត</a>";
                                                        }
                                                    }
                                                    @endphp
                                                </td>
                                        ...
                                        @foreach($row->invitationForConcilationCompany->nextTime as $next)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="form-group col-sm-12 text-info fw-bold">
                                                            <span class="pink">*ចុងចោទ [{{ $next->status->status_name }}]</span>
                                                            ជួបលើកក្រោយថ្ងៃទី <span class="text-danger">{{ date2Display($next->next_date) }}</span>
                                                            ម៉ោង <span class="text-danger">{{ $next->next_time }}</span><br/>
                                                            មូលហេតុ <span class="text-danger">{{ $next->reason }}</span>
                                                        </div>
                                ...
                                @endif
                                <tr>
                                    <td><label class="form-label blue fw-bold">{{ Num2Unicode(8) }}.ការផ្សះផ្សា</label></td>
                                    <td>
                                    ...
                                    <tr>
                                                    ...
                                                    @if($j == $showCaseLog6All['num_log6'])
                                                        @if($showCaseLog6['detail']->status_id == 2)
                                                            @if($showCaseLog6['detail']->reopen_status == 1)
                                                                <div class="row mt-2">
                                                                    <div class="form-group col-sm-12 fw-bold text-info">
                                                                        @if($hasFullAccess)
                                                                        <a href="{{ url('uploads/all/84/'.$row->id.'/'.$showCaseLog6['log6_id']) }}" class="btn btn-success form-control fw-bold">កែប្រែព័ត៌មានសុំផ្សះផ្សាឡើងវិញ</a>
                                                                        @endif
                                                                        <br>
                                                            ...
                                                            @else
                                                                @if($hasFullAccess)
                                                                <div class="form-group col-sm-6"><a href="{{ url('uploads/all/82/'.$row->id.'/'.$showCaseLog6['log6_id']) }}" class="btn btn-success form-control fw-bold">សុំផ្សះផ្សាឡើងវិញ</a></div>
                                                                @endif
                                                            @endif
                                                        @elseif($showCaseLog6['detail']->status_id == 3)
                                                            <div class="row mt-3">
                                                                <div class="form-group col-sm-12">
                                                                    @if($hasFullAccess)
                                                                    <a href="{{ url('uploads/all/83/'.$row->id.'/'.$showCaseLog6['log6_id']) }}" class="btn btn-success form-control fw-bold">កែប្រែព័ត៌មានសុំលើកពេលផ្សះផ្សា</a>
                                                                    @endif
                                                                    <br>
                                                                    <label class="form-label fw-bold text-info">លើកពេលផ្សះផ្សាទៅថ្ងៃទី <span class="text-danger">{{ date2Display($showCaseLog6['detail']->status_date) }}</span>
                                                                    ម៉ោង <span class="text-danger">{{ date2Display($showCaseLog6['detail']->status_time, 'H:i') }}</span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="form-group col-sm-4">
                                                    ...
                                                    @if($j == $showCaseLog6All['num_log6'])
                                                        @if($showCaseLog6['detail']->status_id == 2 && $showCaseLog6['detail']->reopen_status == 1)
                                                            <div class="mt-3">
                                                                @if($hasFullAccess)
                                                                <a href="#" onClick="comfirm_sweetalert2('{{ url("log6/reopen/request/cancel/".$showCaseLog6['detail']->case_id.'/'.$showCaseLog6['detail']->id) }}', 'តើអ្នកពិតជាចង់លុប មែនឫ?')" class="btn btn-danger form-control">                                                                    លុបការសុំផ្សះផ្សាឡើងវិញ
                                                                @endif
                                                                </a>
                                                            </div>
                                                        @endif
                                        ...
                                        <td>
                                            @php
                                                if($hasFullAccess){
                                                    if($showCaseLog6['log6_id'] > 0){
                                                        $showFile = showFile(1, $showCaseLog6['log_file'], pathToDeleteFile('case_doc/log6/'.$caseYear."/"), "delete", "tbl_case_log6", "id", $showCaseLog6['log6_id'],  "log_file", "");
                                                        if($showFile){
                                                            echo $showFile;
                                                        }
                                                        else{
                                                             echo '<a href="'.url('uploads/all/8/'.$row->id.'/'.$showCaseLog6['log6_id']).'" class="btn btn-success form-control fw-bold">'."Upload កំណត់ហេតុ</a>";
                                                        }
                                                    }
                                                }
                                            @endphp
                                            @if($showCaseLog6['detail']->status_id == 2)
                                                <div class="mt-3">
                                                    ...
                                                    if($hasFullAccess){
                                                        if($showCaseLog6['detail']->reopen_status == 1){
                                                            $showFile = showFile(1, $showCaseLog6['detail']->status_letter, pathToDeleteFile('case_doc/log6/status_letter/'.$caseYear.'/'), "delete", "tbl_case_log6", "id", $showCaseLog6['detail']->id,  "status_letter", "");
                                                            if($showFile){
                                                                echo $showFile;
                                                            }
                                                            else{
                                                                echo '<button id="uploadButtonInvitationEmployee" class="btn btn-success form-control uploadButton fw-bold mb-1" value="'.$showCaseLog6['detail']->id.'" data-title="Upload លិខិតស្នើសុំផ្សះផ្សាឡើងវិញ ដែលបានចុះហត្ថលេខា" data-url="'.url('log6/reopen/upload/file').'">Upload លិខិត</button>';
                                                                echo '<a href="'.url('uploads/all/81/'.$row->id.'/'.$showCaseLog6['detail']->id).'" class="btn btn-success form-control fw-bold">'."Upload កំណត់ហេតុ</a>";
                                                            }
                                                        }
                                                    }
                                                    @endphp
                                            ...
                                            @elseif($showCaseLog6['detail']->status_id == 3)
                                                <div class="mt-3">
                                                    @php
                                                    if($hasFullAccess){
                                                        $showFile = showFile(1, $showCaseLog6['detail']->status_letter, pathToDeleteFile('case_doc/log6/status_letter/'), "delete", "tbl_case_log6", "id", $showCaseLog6['detail']->id,  "status_letter", "");
                                                        if($showFile){
                                                            echo $showFile;
                                                        }
                                                        else{
                                        ...
                                        <td class="text-purple text-center fw-bold">
                                                ...
                                                @if( $showCaseLog6['log6']->status->id == 3)
                                                    <br>
                                                    <span class="text-danger fw-bold" style="color:#000000; font-size: 12px;">
                        ...
                        <div class="card-block row text-center mt-4">
                            <div class="form-group  col-sm-12">
                                <a class="btn btn-danger text-hanuman-22" href="{{ url('close/case/'.$row->id) }}" title="ចុចបិទបញ្ចប់សំណុំរឿង" target="">ការបិទបញ្ចប់សំណុំរឿង</a>
                            </div>
                        </div>
                        @endif
                    </div>
