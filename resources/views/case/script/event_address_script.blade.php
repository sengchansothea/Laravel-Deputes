...
// Read data and create <option >
    ...
    function eventAutocomplete(autocomplete_id = "find_autocomplete", response_message_id="response_message", counter = "", name = "name", gender = "gender", dob="dob", nationality="nationality", id_number="id_number", phone_number="phone_number", phone_number2="phone_number2", occupation="occupation", pob_province="pob_province_id", pob_district="pob_district_id", pob_commune="pob_commune", addr_province ="province", addr_district="district", addr_commune="commune", addr_village="village", addr_street="addr_street", addr_house = "addr_house_no"){
            ...
            select: function(event, ui) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#" + phone_number2 + counter).val(data[0].phone_number2).trigger("change");
