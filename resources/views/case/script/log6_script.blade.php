...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // --- Checkbox show/hide log6 Sub Employee ---
        $('#hidden_sub_employee').change(function() {
            if (this.checked) {
                $('#show_sub_employee').prop('checked', false);
                $('#show_information_sub_employee').hide();
            }
        });

        $('#show_sub_employee').change(function() {
            if (this.checked) {
                $('#hidden_sub_employee').prop('checked', false);
                $('#show_information_sub_employee').show();
            }
        });

        // --- Checkbox show/hide log6 Represent Company ---
        $('#hidden_represent_company').change(function() {
            if (this.checked) {
                $('#show_represent_company').prop('checked', false);
                $('#information_represent_company').hide();
            }
        });

        $('#show_represent_company').change(function() {
            if (this.checked) {
                $('#hidden_represent_company').prop('checked', false);
                $('#information_represent_company').show();
            }
        });

        // --- Checkbox show/hide log6 Sub Company ---
        $('#hidden_sub_company').change(function() {
            if (this.checked) {
                $('#show_sub_company').prop('checked', false);
                $('#information_sub_company').hide();
            }
        });
...
`
        ...
        eventChangePob("", "sub_employee_pob_province_id", "sub_employee_pob_district_id",
            "sub_employee_pob_commune_id"); // (1)
        eventChangeAddress("", "sub_employee_province", "sub_employee_district", "sub_employee_commune",
            "sub_employee_village"); // (2)
        eventAutocomplete(
            ...
            "sub_employee_id_number", "sub_employee_phone_number", "sub_employee_phone2_number",
            "sub_employee_occupation",
            "sub_employee_pob_province_id", "sub_employee_pob_district_id", "sub_employee_pob_commune_id",
            "sub_employee_province", "sub_employee_district", "sub_employee_commune",
        ...
        eventChangePob("", "represent_company_pob_province_id", "represent_company_pob_district_id",
            "represent_company_pob_commune_id"); // (1)
        eventChangeAddress("", "represent_company_province", "represent_company_district",
            "represent_company_commune", "represent_company_village"); // (2)
        eventAutocomplete(
            "find_represent_company_autocomplete", "response_message_company",
            "",
            "represent_company_name", "represent_company_gender", "represent_company_dob",
            "represent_company_nationality",
            "represent_company_id_number", "represent_company_phone_number",
            "represent_company_phone2_number", "represent_company_occupation",
            "represent_company_pob_province_id", "represent_company_pob_district_id",
            "represent_company_pob_commune_id",
            "represent_company_province", "represent_company_district", "represent_company_commune",
        ...
        eventChangePob("", "sub_company_pob_province_id", "sub_company_pob_district_id",
            "sub_company_pob_commune_id"); // (1)
        eventChangeAddress("", "sub_company_province", "sub_company_district", "sub_company_commune",
            "sub_company_village"); // (2)
        eventAutocomplete(
            ...
            "sub_company_id_number", "sub_company_phone_number", "sub_company_phone2_number",
            "sub_company_occupation",
        ...
        $("#log6_date, #sub_employee_dob, #represent_company_dob, #sub_company_dob, #log6_stime, #log6_etime")
            .keydown(function(event) {
                return false;
            });
        $("#sub_employee_phone_number1, #represent_company_phone_number, #sub_company_phone_number1").keypress(
            function(event) {
        ...
        $("#sub_employee_id_number1, #represent_company_id_number, #sub_company_id_number1").keypress(function(
            event) {
