...
<x-admin.layout-main :adata="$adata" >
    ...
    <div class="container-fluid">
        <div class="row starter-main">
            <div class="col-sm-12">
                <div class="card">
                    <form action="{{ url('invitations') }}" method="POST" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                                ...
                                <div class="col-sm-12 col-lg-12 col-xl-12">
                                    <div class="row">
                                        <div class="form-group col-sm-6 mt-3">
                                            <label class="text-purple text-hanuman-24 required fw-bold mb-1">លេខលិខិតអញ្ជើញ</label>
                                    ...
                                    @else
                                        <div class="row">
                                            @if(!empty($row->caseCompany->log5_company_phone_number2))
                                                ...
                                                <div class="form-group col-sm-3 mt-3">
                                                    <labe class="fw-bold mb-1">លេខចុះបញ្ជីពាណិជ្ជកម្ម</label>
                                            ...
                                            @else
                                                ...
                                                <div class="form-group col-sm-6 mt-3">
                                                    <label for="company_name_latin" class="fw-bold mb-1">ឈ្មោះជាភាសាឡាតាំង</label>
                                                    <input type="text" id="company_name_latin" value="{{ $row->company->company_name_latin }}" class="form-control" readonly />
                                                </div>
                                                <div class="form-group col-sm-3 mt-3">
                                                    <label class="fw-bold mb-1">អាសយដ្ឋាន</label>
...
{{--                                            <input type="text" name="reason" value="{{ $row->case_objective_des }}" class="form-control" disabled />--}}
                                    ...
                                    @php
                                        $defaultValue = $adata['employee_or_company'] == 1 ? '' : 'កិច្ចសន្យាការងារ ប័ណ្ណពន្ធប៉ាតង់ បញ្ជីពាណិជ្ជកម្ម  លក្ខន្តិកៈសំណុំឯកសារចុះបញ្ជីនៅក្រសួងការងាររួមមាន៖ សេចក្តីប្រកាសជូនដំណឹងបើកសហគ្រាស បទបញ្ជាផ្ទៃក្នុង និងរួមទាំងឯកសារពាក់ព័ន្ធភស្តុតាងផ្សេងៗ';
                                    @endphp
                                    <div class="row">
                                        <div class="form-group col-sm-12 mt-3">
                                            ...
                                            <input
                                                type="text"
                                                name="invitation_required_doc"
                                                id="invitation_required_doc"
                                                class="form-control"
                                                value="{{ $defaultValue }}"
                                            />
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-6 mt-3">
                                            <input type="text" name="contact_phone" id="contact_phone" value="{{ $row->caseCompany->log5_company_phone_number }}" class="form-control" minlength="9" maxlength="10" >
                                        </div>
                                    </div>
                                    <div class="row mt-4">
