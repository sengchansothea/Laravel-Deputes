        ...
        <div class="row starter-main">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body row mt-2">
                        <div class="form-group col-sm-4">
                            <a class="btn btn-info custom form-control fw-bold"
                                href="{{ url('export/word/case/log34/' . $log34->id) }}" title="Download"
                        ...
                        @if (
                            $chkAllowAccess ||
                                ...
                                (auth()->user()->id == $row->user_created && $row->invitationForConcilation->isEmpty()))
                            <div class="form-group col-sm-4">
                    ...
                    <form name="formUpdateLog34" action="{{ url('log34/' . $log34->id) }}" method="POST"
                        ...
                        <div class="card-body text-hanuman-17">
                            ...
                            <div id="plantiff_block">
                                <div class="row">
                                    <div class="form-group col-sm-4 mt-3">
                                        ...
                                        <input type="text"
                                            value="{{ $row->disputant->name }} {{ $row->disputant->name_latin }}"
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-6 mt-3">
                                        ...
                                        <input type="text"
                                            value="{{ $row->company->company_name_khmer }} {{ $row->company->company_name_latin }}"
                                            class="form-control" disabled />
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-4 mt-3">
                                        ...
                                        <div class="input-group clockpicker" data-autoclose="true">
                                            <input name="meeting_stime" id="meeting_stime"
                                                value="{{ old('meeting_stime', date2Display($log34->meeting_stime, 'H:i')) }}"
                                    ...
                                    <div class="form-group col-sm-12 mt-3">
                                        ...
                                        {!! showTextarea(
                                            'disputant_give_info',
                                            old('disputant_give_info', $log34->disputant_give_info),
                                            '4',
                                            'required',
                                        ) !!}
                                    </div>
                                ...
                                @php
                                    ...
                                    $officerNoter = !empty($adata['log34_noter'])
                                        ? $adata['log34_noter']->attendant_id
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        {!! showSelect(
                                            'attendant_disputant_id',
                                            arrayDisputant($row->disputant_id),
                                            old('attendant_disputant_id'),
                                            ' select2',
                                            '',
                                            '',
                                            '',
                                        ...
                                        <div class="form-group col-sm-3 mt-3">
                                            <label class="fw-bold" style="margin-bottom: 6px;">
                                                ...
                                                @if ($chkAllowAccess || in_array($userOfficerID, $arrOfficerIDs) || auth()->user()->id == $row->user_created)
                                                    @php
                                                        $deleteUrl = url(
                                                            'log34/delete/sub_disputant/' .
                                                                $row_sub_disputant->id .
                                                                '_' .
                                                                $log34->id,
                                                        );
                                                        $onClick =
                                            ...
                                            <input type="text" value="{{ $row_sub_disputant->disputant->name }}"
                                                class="form-control " disabled />
                                        </div>
                                    @endforeach
                                    <div class="form-group col-sm-3 mt-3">
                                        <label class="fw-bold required mb-2" style="visibility: hidden ">X</label>
                                        <button id="btn_add_employee_sub" value="0" type="button"
                                            class="form-control btn btn-primary fw-bold">បន្ថែមឈ្មោះអមកម្មករ</button>
                                    </div>
                                ...
                                <div id="add_employee_blog" style="display: none;">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12 mt-3">
                                            ...
                                            <input type="text" name="find_employee_autocomplete" minlength="2"
                                    ...
                                    <div class="row mt-3">
                                        <div class="form-group col-sm-4 mt-3">
                                            <label class="fw-bold mb-1 required2"
                                                for="name">ឈ្មោះអមអ្នកប្ដឹង</label>
                                            <input type="text" name="name[]" value="{{ old('name[]') }}"
                                                class="form-control" id="name">
                                        </div>
                                        <div class="form-group col-sm-2 mt-3">
                                            <label class="fw-bold mb-1 required2">ភេទ</label>
                                            {!! showSelect('gender[]', ['1' => 'ប្រុស', '2' => 'ស្រី'], old('gender[]'), ' select2', '', 'gender') !!}
                                        </div>
                                        <div class="form-group col-sm-3 mt-3">
                                        ...
                                        <div class="form-group col-sm-3 mt-3">
                                            ...
                                            <input type="text" name="phone2_number[]" id="phone2_number"
                                        ...
                                        <div class="form-group col-sm-3 mt-3">
                                            ...
                                            {!! showSelect('pob_district_id[]', [], old('pob_district_id[]'), ' select2', '', 'pob_district_id', '') !!}
                                        </div>
                                        <div class="form-group col-sm-3 mt-3">
                                            <label class="fw-bold mb-1">ឃុំ-សង្កាត់</label>
                                            {!! showSelect('pob_commune_id[]', [], old('pob_commune_id[]'), ' select2', '', 'pob_commune_id', '') !!}
                                        </div>
                                        <div class="form-group col-sm-3 mt-3">
                                        ...
                                        <div class="form-group col-sm-3 mt-3">
                                            ...
                                            {!! showSelect('district[]', [], old('pob_district[]'), ' select2', '', 'district', '') !!}
                                        </div>
                                        <div class="form-group col-sm-3 mt-3">
                                            <label class="fw-bold mb-1 required2">ឃុំ-សង្កាត់</label>
                                            {!! showSelect('commune[]', [], old('commune[]'), ' select2', '', 'commune', '') !!}
                                        </div>
                                        <div class="form-group col-sm-2 mt-3">
                                            <label class="fw-bold mb-1">ភូមិ</label>
                                            {!! showSelect('village[]', [], old('village[]'), ' select2', '', 'village', '') !!}
                                        </div>
                                        <div class="form-group col-sm-2 mt-3">
                                            <label class="fw-bold mb-1" for="case_type">ផ្ទះលេខ</label>
                                            <input type="text" name="addr_house_no[]" id="addr_house_no"
                            ...
                            <div id="contract_block" style="display:none;">
                                <div>
                                    <h3 class="text-center text-hanuman-20 fw-bold pink">
                                        បទបញ្ញត្តិស្តីពីលក្ខខណ្ឌការងារ និងការរំលាយកិច្ចសន្យាការងារ
                                    </h3>
                                </div>
                                <br>
                                <div class="row">
