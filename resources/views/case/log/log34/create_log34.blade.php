...
<x-admin.layout-main :adata="$adata">
    ...
    <div class="container-fluid">
        <div class="row starter-main">
            <div class="col-sm-12">
                <div class="card">
                    <form name="formCreateCase" action="{{ url('log34') }}" method="POST"
                        ...
                        <div class="card-body text-hanuman-17">
                                    ...
                                    <div class="col-sm-12 col-lg-12 col-xl-12">
                                        ...
                                        <div class="row col-12">
                                            ...
                                            <div class="form-group col-sm-4 mt-3">
                                                ...
                                                <input type="text"
                                                    value="{{ $row->caseCompany->province->pro_khname }}"
                                                    class="form-control" disabled />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row col-12 mt-3">
                                            <div class="form-group col-sm-4 mt-3">
                                                <label
                                                    class="fw-bold mb-1 blue text-hanuman-18">តើមានអ្នកអមបណ្ដឹងដែរឬទេ?</label>
                                                <span class="ms-2 pink text-hanuman-18">
                                                    <input type="checkbox" id="show_complainant" class="me-1"
                                                        style="width: 18px;height:18px;">
                                                    <label for="show" class="me-2">មាន</label>
                                                    <input type="checkbox" id="hidden_complainant" class="me-1"
                                                        style="width: 18px;height:18px;">
                                        ...
                                        {{-- Search for the name of the complainant --}}
                                        <div id="information_complainant" style="display: none">
                            ...
                            <div id="contract_block" style="display:none;">
                                ...
                                <div class="row col-12">
                                    ...
                                    <div class="form-group col-sm-4 mt-3">
                                        <label class="fw-bold mb-1 required blue">ម៉ោងបញ្ចប់</label>
                                        <div class="input-group clockpicker" data-autoclose="true">
                                ...
                                <div class="row col-12">
                                    ...
                                    <div class="form-group col-sm-3 mt-3">
                                        <button type="submit" class="btn btn-success form-control fw-bold">
                                            រក្សាទុក
                                        </button>
                                    </div>
                                </div>
