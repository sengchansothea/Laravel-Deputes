...
{{--                            @endif--}}
                        ...
                        <div class="form-group col-sm-4">
                            <form name="frmDelete" action = "{{ url('collectives_log6'.'/'.$log6->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                    ...
                    <form name="formCreateCase" action="{{ url('collectives_log6/'.$log6->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <input type="hidden" name="log_id" value="{{ $log6->log_id }}" >
                        <input type="hidden" name="case_id" value="{{ $log6->case_id }}" >
                        <input type="hidden" name="case_date" value="{{ $case->case_date }}">
                        ...
                        <div class="card-body text-hanuman-17">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4 mt-3">
                                    ...
                                    <input type="text"  value="{{ old('case_date', date2Display($case->case_date)) }}" class="form-control"  data-language="en" readonly >
                                </div>
                                <div class="form-group col-sm-4 mt-3">
                                    <label class="fw-bold mb-1 required">កាលបរិចេ្ឆទនៃវិវាទដែលបានប្ដឹងទៅអធិការការងារ</label>
                                    <input type="text" value="{{ old('case_date_entry', date2Display($case->case_date_entry)) }}" class="form-control"  data-language="en" readonly >
                                </div>
                                <div class="form-group col-sm-4 mt-3">
                                    <label class="fw-bold mb-1 required">កាលបរិចេ្ឆទដែលរដ្ឋមន្ដ្រីជ្រើសតាំងអ្នកផ្សះផ្សា</label>
                                    <input type="text" value="{{ old('assigned_officer_date', date2Display($case->collectives_assigned_officer_date)) }}" class="form-control"  data-language="en" readonly >
                                </div>
                            </div>
                            <div class="row col-12  mt-5">
                                <label class="text-purple text-hanuman-24" for="contact_phone">
                                    ខ. សេចក្ដីពិស្ដារនៃកិច្ចប្រជុំ
                                </label>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6 mt-3">
                                    ...
                                    <input type="number" name="log6_emp_involved" id="log6_emp_involved" class="form-control" value="{{ old('log6_emp_involved', $log6->log6_emp_involved) }}" required>
                                </div>

                                <div class="form-group col-sm-6 mt-3">
                                    <label class="fw-bold mb-1 required">ចំនួនកម្មករសរុប</label>
                                    <input type="number" name="log6_emp_total" id="log6_emp_total" class="form-control" value="{{ old('log6_emp_total', $log6->log6_emp_total) }}" required />
                                </div>
                            </div>
                                    ...
                                    @foreach($adata['employee_sub'] as $employeeSub)
                                        <div class="form-group col-sm-3 mt-3">
                                            <label class="fw-bold" style="margin-bottom: 6px;">
                                                ឈ្មោះ
                                                @php
                                                    $deleteUrl = url('collectives/log6/delete/log_attendant/'.$employeeSub->id.'_'.$log6->id);
                            ...
                            <div class="row2">
                                <div class="form-group col-sm-12 mt-3">
                                    <label for="case_type" class="text-primary text-hanuman-18 fw-bold mb-1"> ស្វែងរកឈ្មោះអ្នកអមកម្មករ</label>
                            ...
                            <div class="row col-12  mt-5">
                                <label class="text-purple text-hanuman-24" for="contact_phone">
                                    ...
                                    @elseif($case->case_type_id == 2)
                                        (ដើមបណ្ដឹង)
                                    @endif
                                    <button type="button" id="btn_company" value="1" class="btn btn-info fw-bold">បង្ហាញពត៌មានលម្អិត</button>
                                </label>
                            </div>
                                    ...
                                    @foreach($adata['company_main'] as $companyMain)
                                        <div class="form-group col-sm-3 mt-3">
                                            <label class="fw-bold" style="margin-bottom: 6px;">
                                                អ្នកតំណាងនិយោជក
                                                @php
                                                    $deleteUrl = url('collectives/log6/delete/log_attendant/'.$companyMain->id.'_'.$log6->id);
                                                    $onClick = "comfirm_delete_steetalert2('".$deleteUrl."','តើអ្នកពិតជាចង់លុប មែនឫ?')";
                                                    $str2='<button type="button" class="btn btn-danger btn-xxs" onClick="'.$onClick.'" title="Delete"><i data-feather="trash"></i></button>';
                                                    echo $str2;
                                                @endphp
                                    ...
                                    @foreach($adata['company_sub'] as $companySub)
                                        <div class="form-group col-sm-3 mt-3">
                                            ...
                                            <label class="fw-bold" style="margin-bottom: 6px;">
                                               អ្នកដែលអមនិយោជក
                                                @php
                                                    $deleteUrl = url('collectives/log6/delete/log_attendant/'.$companySub->id.'_'.$log6->id);
                                                        $onClick = "comfirm_delete_steetalert2('".$deleteUrl."','តើអ្នកពិតជាចង់លុប មែនឫ?')";
                                                    $str2='<button type="button" class="btn btn-danger btn-xxs" onClick="'.$onClick.'" title="Delete"><i data-feather="trash"></i></button>';
                                                    echo $str2;
                                                @endphp
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="form-group col-sm-3 mt-3">
                                    <label for="phone_number" class="required2 fw-bold mb-1">លេខទូរស័ព្ទខ្សែទី២</label>
                            ...
                            <div class="row">
                                @php
                                    ...
                                    $officerId = !empty($adata['conflict_officer']) ? $adata['conflict_officer']->attendant_id : 0;
                                    $officerNoter = !empty($adata['conflict_noter']) ? $adata['conflict_noter']->attendant_id : 0;
                                ...
                                <div class="form-group col-sm-3 mt-4">
                                    <label class="fw-bold required" style="margin-bottom: 11px">
                                        អ្នកផ្សះផ្សា </label>
                                    {!! showSelect('head_meeting', arrayOfficer($officerId), old('head_meeting', request('pob_province_id')), " select2", "", "", "") !!}
                                </div>
                                <div class="form-group col-sm-3 mt-4">
                                    <label class="fw-bold required" style="margin-bottom: 11px">អ្នកកត់ត្រា</label>
                                        ...
                                        <div class="form-group col-sm-3 mt-3">
                                            <label class="fw-bold" style="margin-bottom: 6px;">
                                                ...
                                                @php
                                                    ...
                                                    $deleteUrl = url('collectives/log6/delete/log_attendant/'.$officerSub->id.'_'.$log6->id);
                                                        $onClick = "comfirm_delete_steetalert2('".$deleteUrl."','តើអ្នកពិតជាចង់លុប មែនឫ?')";
                                                    $str2='<button type="button" class="btn btn-danger btn-xxs" onClick="'.$onClick.'" title="Delete"><i data-feather="trash"></i></button>';
                                                    echo $str2;
                                                @endphp
...
{{--                            {{ dd($officerNoter) }}--}}
{{--                            {{ dd(arrayOfficer(0, 1, 0)) }}--}}
{{--                            {{ dd(myArrOfficerExcept([$officerId, $officerNoter], 1, 0)) }}--}}

                            <div id="officer_1" class="row mt-3">
                                <div id="officer_1" class="form-group col-sm-6 mt-2">
                                    <label class="fw-bold mb-1 required">
                                ...
                                @if($log6->log620->count() > 0)
                                    ...
                                    @foreach($log6->log620 as $log620)
                                        ...
                                        <div class="form-group col-sm-2 mt-5">
                                            @php
                                                $deleteUrl = url('collectives/log6/delete/log620/'.$log620->id.'_'.$log6->id);
                                                    $onClick = "comfirm_delete_steetalert2('".$deleteUrl."','តើអ្នកពិតជាចង់លុប មែនឫ?')";
                            ...
                            <div class="row">
                                @if($log6->log621->count() > 0)
                                    ...
                                    @foreach($log6->log621 as $log621)
                                        ...
                                        <div class="form-group col-sm-2 mt-5">
                                            @php
                                                $deleteUrl = url('collectives/log6/delete/log621/'.$log621->id.'_'.$log6->id);
                                                    $onClick = "comfirm_delete_steetalert2('".$deleteUrl."','តើអ្នកពិតជាចង់លុប មែនឫ?')";
                                                $str2='<button type="button" class="btn btn-danger" onClick="'.$onClick.'" title="Delete"><i data-feather="trash"></i></button>';
                                                echo $str2;
                                            @endphp
...
{{--                                            <input type="text" name="log621_solution[]" value="{{ old('log621_solution[]') }}" class="form-control">--}}
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 mt-5">
                                    <label class="fw-bold mb-2 text-primary" for="contact_phone">
                            ...
                            <div class="row mt-5">
                                <div class="form-group col-sm-4">
                                    <label class="fw-bold mb-1 pink">ឈ្មោះអ្នកបកប្រែបើមាន</label>
                                    <input type="text" name="translator" value="{{ old('translator', $log6->translator) }}" class="form-control" >
                                </div>
                                <div class="form-group col-sm-8">
                                    <label class="fw-bold mb-1 pink">លិខិតផ្ទេរសិទ្ធិ</label>
                                    <input type="hidden" name="translator_letter_old" value="{{ $log6->translator_letter }}" >
                                    @php
                                        $show_file= showFile(1, $log6->translator_letter, pathToDeleteFile('case_doc/collectives/log6/'.$caseYear."/"), "delete", "tbl_case_log6", "log_id", $log6->log_id,  "translator_letter");
                                        if($show_file){
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-3 mt-3">
                                    ...
                                    <input type="text" name="log624_cause_other" value="{{ $log6->log624_cause_other }}" class="form-control">
                                </div>
                            </div>
...
{{--                                </div>--}}
                                <div id="show_upload_status_letter" class="row">
                                    ...
                                    <div class="form-group col-sm-3">
                                        ...
                                        <div class="input-group clockpicker" data-autoclose="true">
                                            <input name="status_time" id="status_time" value="{{ old('status_time', $log6->status_time) }}" class="form-control" type="text" data-bs-original-title="" required >
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label class="fw-bold mb-1">លិខិតលើកពេលផ្សះផ្សា</label>
                                        <input type="hidden" name="status_letter_old" value="{{ $log6->status_letter }}" >
                                        @php
                                            $show_file = showFile(1, $log6->status_letter, pathToDeleteFile('case_doc/collectives/log6/status_letter/'.$caseYear."/"), "delete", "tbl_case_log6", "log_id", $log6->log_id,  "status_letter");
                                            if($show_file){
                                                echo "<br><div class='mt-1'>".$show_file."</div>";
                                            }
                                            else{
