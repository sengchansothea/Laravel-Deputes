                ...
                <div class="card">
                    <div class="card-body row mt-2">
                        <div class="form-group col-sm-4">
                            <a class="btn btn-info custom form-control" href="{{ url('export/word/case/log6/'.$log6->id) }}" title="Download" target="_blank">ទាញយកកំណត់ហេតុ
                            </a>
                        </div>
                        <div class="form-group col-sm-4">
{{--                            @if($log6->status_id == 2)--}}
...
{{--                            @endif--}}
                    ...
                    <form name="formCreateCase" action="{{ url('log6/'.$log6->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <input type="hidden" name="invitation_id_employee" value="{{ $log6->invitation_id_employee }}" >
                        ...
                        <input type="hidden" name="current_status_id" id="current_status_id" value="{{ $log6->status_id }}" >
                        ...
                        <div class="card-body text-hanuman-17">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6 mt-3">
                                    ...
                                    <input type="text"  value="{{ old('meeting_date', date2Display($row->case_date)) }}" class="form-control"  data-language="en" disabled >
                                </div>
                                <div class="form-group col-sm-6 mt-3">
                                    <label class="fw-bold mb-1">២. កាលបរិចេ្ឆទនៃវិវាទដែលបានប្ដឹងទៅអធិការការងារ</label>
                                    <input type="text" value="{{ old('meeting_date', date2Display($row->case_date_entry)) }}" class="form-control"  data-language="en" disabled >
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-3 mt-3">
                                    ...
                                    <input type="text"  name="log6_date" id="log6_date" value="{{ old('log6_date', $log6->log6_date) }}" class="form-control"  data-language="en" required >
                                </div>
                                <div class="form-group col-sm-3 mt-3">
                                    <label class="fw-bold mb-1 required">ម៉ោងចាប់ផ្ដើម</label>
                                    <div class="input-group clockpicker" data-autoclose="true">
                                        <input name="log6_stime" id="log6_stime" value="{{ old("log6_stime", date2Display($log6->log6_stime,'H:i')) }}"  class="form-control" type="text" data-bs-original-title="" required >
                                    </div>
                                </div>
                                <div class="form-group col-sm-3 mt-3">
                                    <label class="fw-bold mb-1 required">ម៉ោងបញ្ចប់</label>
                                    <div class="input-group clockpicker" data-autoclose="true">
                                        <input name="log6_etime" id="log6_etime" value="{{ old("log6_etime", date2Display($log6->log6_etime,'H:i')) }}"  class="form-control" type="text" data-bs-original-title="" required >
                                    </div>
                                </div>
                                <div class="form-group col-sm-3 mt-3">
                                    <label class="fw-bold mb-1 required">៤. ទីកន្លែងប្រជុំ</label>
                                    {!! showSelect('log6_meeting_place_id', array(1=>"នៅនាយកដ្ឋានវិវាទការងារ (ភ្នំពេញ)", 2 =>"នៅកន្លែងផ្សេង"), old('log6_meeting_place_id', $log6->log6_meeting_place_id), " select2", "", "", "") !!}
                                </div>
                                <div class="form-group col-sm-3 mt-3">
                                    <label class="fw-bold mb-1">បើប្រជុំនៅកន្លែងផ្សេង</label>
                                    <input type="text" name="log6_meeting_other" value="{{ old('log6_meeting_other', $log6->log6_meeting_other) }}" class="form-control">
                                </div>

                                <div class="form-group col-sm-9 mt-3">
                                    <label class="fw-bold mb-1 required">ដើម្បីផ្សះផ្សាវិវាទបុគ្គល ស្ដីពី</label>
                                    <input type="text" name="log6_meeting_about" value="{{ old('log6_meeting_about', $log6->log6_meeting_about) }}" id="log6_meeting_about" class="form-control" required />
                                </div>
                            </div>
                            ...
                            <div id="r1Employee" class="row" style="display: none">
                                ...
                                <div class="form-group col-sm-2 mt-3">
                                    ...
                                    <input type="text" value="{{ $row->disputant->dob }}" class="form-control" disabled />
                                </div>
                                <div class="form-group col-sm-2 mt-3">
                                ...
                                <div class="form-group col-sm-4 mt-3">
                                    ...
                                    <input type="text" value="@if(!empty($row->disputant->pobCommune)) {{ $row->disputant->pobCommune->com_khname }} @endif" class="form-control" disabled />
                                </div>
                                <div class="form-group col-sm-2 mt-3">
                                    <label class="fw-bold mb-1">ក្រុង-ស្រុក-ខណ្ឌ</label>
                                    <input type="text" value="@if(!empty($row->disputant->pobDistrict)) {{ $row->disputant->pobDistrict->dis_khname }} @endif" class="form-control" disabled />
                                </div>
                                <div class="form-group col-sm-2 mt-3">
                                    <label class="fw-bold mb-1">រាជធានី-ខេត្ត</label>
                                    <input type="text" value="@if(!empty($row->disputant->pobProvince)) {{ $row->disputant->pobProvince->pro_khname }} @endif" class="form-control" disabled />
                                </div>
                            ...
                            <div id="r2Employee" class="row" style="display: none">
                                <div class="form-group col-sm-3 mt-3">
                                    ...
                                    <input type="text" value="{{ $row->caseDisputant->house_no }}" class="form-control" disabled />
                                </div>
                                <div class="form-group col-sm-1 mt-3">
                                    <label class="fw-bold mb-1">ផ្លូវ</label>
                                    <input type="text" value="{{ $row->caseDisputant->street }}" class="form-control" disabled />
                                </div>
                                <div class="form-group col-sm-2 mt-3">
                                    <label class="fw-bold mb-1">ភូមិ</label>
                                    <input type="text" value="@if(!empty($row->caseDisputant->addressVillage)) {{ $row->caseDisputant->addressVillage->vil_khname }} @endif" class="form-control" disabled />
                                </div>
                                <div class="form-group col-sm-2 mt-3">
                                    <label class="fw-bold mb-1">ឃុំ-សង្កាត់</label>
                                    <input type="text" value="@if(!empty($row->caseDisputant->addressCommune)) {{ $row->caseDisputant->addressCommune->com_khname }} @endif" class="form-control" disabled />
                                </div>
                                <div class="form-group col-sm-2 mt-3">
                                    <label class="fw-bold mb-1">ក្រុង-ស្រុក-ខណ្ឌ</label>
                                    <input type="text" value="@if(!empty($row->caseDisputant->addressDistrict)) {{ $row->caseDisputant->addressDistrict->dis_khname }} @endif" class="form-control" disabled />
                                </div>
                                <div class="form-group col-sm-2 mt-3">
                                    <label class="fw-bold mb-1">រាជធានី-ខេត្ត</label>
                                    <input type="text" value="@if(!empty($row->caseDisputant->addressProvince)) {{ $row->caseDisputant->addressProvince->pro_khname }} @endif" class="form-control" disabled />
                                </div>
                            </div>
                                    ...
                                    @foreach($adata['employee_sub'] as $employeeSub)
                                        <div class="form-group col-sm-3 mt-3">
                                            <label class="fw-bold" style="margin-bottom: 6px;">
                                                ...
                                                @if($chkAllowAccess || in_array($userOfficerID, $arrOfficerIDs) || auth()->user()->id == $row->user_created)
                                                @php
                                                    $deleteUrl = url('log6/delete/log_attendant/'.$employeeSub->id.'_'.$log6->id);
                                            ...
                                            <input type="text" value="{{ $employeeSub->disputant->name }}" class="form-control" disabled />
                                            <input type="hidden" name="employee_sub_id[]" value="{{ $employeeSub->disputant->id }}" />
                                        </div>
                                    @endforeach
                                @endif
                            </div>
                            <div class="form-group col-12 mt-3">
                                <div id="response_message_sub_employee" class="text-warning fw-bold" style="display: none;">Waiting for response...</div>
                            </div>
                            <div class="row2">
                                <div class="form-group col-sm-12 mt-3">
                                    <label for="case_type" class="fw-bold pink text-hanuman-18 fw-bold mb-1"> ស្វែងរកឈ្មោះអ្នកអមកម្មករ</label>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="form-group col-sm-3 mt-3">
                                    ...
                                    <input type="text" name="sub_employee_occupation[]" id="sub_employee_occupation" value="{{ old('sub_employee_occupation[]') }}" class="form-control" >
                                </div>
                                <div class="form-group col-sm-3 mt-3">
                            ...
                            <div class="row col-12  mt-5">
                                <label class="text-purple text-hanuman-24" for="contact_phone">
                                    ...
                                    @elseif($row->case_type_id == 2)
                                        (ដើមបណ្ដឹង)
                                    @endif
                                    <button type="button" id="btn_company" value="1" class="btn btn-success">បង្ហាញព័ត៌មានលម្អិត</button>
                                </label>
                            </div>
                            <div id="r1Company" class="row col-12" style="display: none">
                                ...
                                <div class="form-group col-sm-4 mt-3">
                                    ...
                                    <input type="text" value="{{ $row->caseCompany->log5_head_building_no }}" class="form-control" disabled />
                                </div>
                                <div class="form-group col-sm-4 mt-3">
                                    <label class="fw-bold mb-1">ផ្លូវ</label>
                                    <input type="text" value="{{ $row->caseCompany->log5_head_building_no }}" class="form-control" disabled />
                                ...
                                <div class="form-group col-sm-4 mt-3">
                                    <label class="fw-bold mb-1">ភូមិ</label>
                                    <input type="text" value="@if(!empty($row->caseCompany->village->vil_khname)){{  $row->caseCompany->village->vil_khname }} @endif" class="form-control" disabled />
                                </div>
                                <div class="form-group col-sm-3 mt-3">
                                    <label class="fw-bold mb-1">ឃុំ-សង្កាត់</label>
                                    <input type="text" value="{{ $row->caseCompany->commune->com_khname }}" class="form-control" disabled />
                                </div>
                                <div class="form-group col-sm-3 mt-3">
                                    <label class="fw-bold mb-1">ក្រុង-ស្រុក-ខណ្ឌ</label>
                            ...
                            <div id="r2Company" class="row col-12" style="display: none">
                                <div class="form-group col-sm-4 mt-3">
                                    ...
                                    <input type="text" value="{{ $row->caseCompany->log5_total_employee }}" class="form-control" disabled />
                                </div>
                                <div class="form-group col-sm-4 mt-3">
                                    <label class="fw-bold mb-1">ចំនួនកម្មករនិយោជិតស្រី</label>
                                    <input type="text" value="{{ $row->caseCompany->log5_total_employee_female }}" class="form-control" disabled />
                                </div>
                                <div class="form-group col-sm-4 mt-3">
                                    <label class="fw-bold mb-1">១៣. សកម្មភាពអាជីវកម្មចម្បង</label>
                                    <input type="text" value="{{ $row->caseCompany->log5_first_business_act }}" class="form-control" disabled />
                                </div>
                            </div>
                            {{--                                    Represent Company--}}
                            <div class="row col-12 mt-4">
                                    ...
                                    @foreach($adata['company_main'] as $companyMain)
                                        <div class="form-group col-sm-3 mt-3">
                                            <label class="fw-bold mb-1" style="margin-bottom: 6px;">
                                                ...
                                                @if($chkAllowAccess || in_array($userOfficerID, $arrOfficerIDs) || auth()->user()->id == $row->user_created)
                                                @php
                                                    $deleteUrl = url('log6/delete/log_attendant/'.$companyMain->id.'_'.$log6->id);
                                                    $onClick = "comfirm_delete_steetalert2('".$deleteUrl."','តើអ្នកពិតជាចង់លុប មែនឫ?')";
                                                    $str2='<button type="button" class="btn btn-danger btn-xxs" onClick="'.$onClick.'" title="Delete"><i data-feather="trash"></i></button>';
                                                    echo $str2;
                                                @endphp
                                            ...
                                            <input type="text" name="company_main_name" value="{{ $companyMain->disputant->name }}" class="form-control" disabled />
                                            <input type="hidden" name="company_main_id" value="{{ $companyMain->disputant->id }}" />
                                        </div>
                                    @endforeach
                                @endif
                            </div>
                            ...
                            <div class="form-group col-12 mt-3">
                                <div id="response_message_company" class="text-warning fw-bold"  style="display: none;">Waiting for response...</div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-12 mt-3">
                                    <label for="case_type" class="pink text-hanuman-18 fw-bold mb-1"> ស្វែងរកឈ្មោះតំណាងនិយោជក</label>
                                    ...
                                    @foreach($adata['company_sub'] as $companySub)
                                        <div class="form-group col-sm-3 mt-3">
                                            ...
                                            <label class="fw-bold" style="margin-bottom: 6px;">
                                                ...
                                                @if($chkAllowAccess || in_array($userOfficerID, $arrOfficerIDs) || auth()->user()->id == $row->user_created)
                                                @php
                                                    $deleteUrl = url('log6/delete/log_attendant/'.$companySub->id.'_'.$log6->id);
                                                        $onClick = "comfirm_delete_steetalert2('".$deleteUrl."','តើអ្នកពិតជាចង់លុប មែនឫ?')";
                                                    $str2='<button type="button" class="btn btn-danger btn-xxs" onClick="'.$onClick.'" title="Delete"><i data-feather="trash"></i></button>';
                                                    echo $str2;
                                                @endphp
                                            ...
                                            <input type="text" value="{{ $companySub->disputant->name }}" class="form-control" disabled />
                                        </div>
                                    @endforeach
                                @endif
                            </div>
                            <div class="form-group col-12 mt-3">
                                <div id="response_message_sub_company" class="text-warning fw-bold" style="display: none;">Waiting for response...</div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-12 mt-3">
                                    <label for="case_type" class="pink text-hanuman-18 mb-1 fw-bold"> ស្វែងរកឈ្មោះអ្នកអមនិយោជក</label>
                                    ...
                                    @foreach($adata['sub_officer'] as $officerSub)
                                        <div class="form-group col-sm-3 mt-3">
                                            <label class="fw-bold mb-2">
                                                ...
                                                @if($chkAllowAccess || in_array($userOfficerID, $arrOfficerIDs) || auth()->user()->id == $row->user_created)
                                                @php
                                                    array_push($arrExcludedOfficerID, $officerSub->attendant_id);
                                                    $deleteUrl = url('log6/delete/log_attendant/'.$officerSub->id.'_'.$log6->id);
                                                        $onClick = "comfirm_delete_steetalert2('".$deleteUrl."','តើអ្នកពិតជាចង់លុប មែនឫ?')";
                                                    $str2='<button type="button" class="btn btn-danger btn-xxs" onClick="'.$onClick.'" title="Delete"><i data-feather="trash"></i></button>';
                                                    echo $str2;
                                                @endphp
                                            ...
                                            <input type="text" value="{{ $officerSub->officer->officer_name_khmer }}" class="form-control" disabled />
                                        </div>
                                    @endforeach
                                @endif
...
{{--                                            {!! showSelect('sub_officer[]', arrayOfficer(0, 1, 0), old('sub_officer'), " select2", "", "sub_officer1", "") !!}--}}
                            ...
                            <div class="row col-12 mt-3">
                                <label class="fw-bold mb-1">២០. ចំណុចព្រមព្រៀងរបស់គូភាគី <span class="text-danger">(ប្រសិនបើមាន សូមបំពេញទាំងចំណុចព្រមព្រៀង និង ដំណោះស្រាយ)</span></label>
                            </div>
                            <div class="row mt-3">
                                ...
                                @if($log6->log620->count() > 0)
                                    ...
                                    @foreach($log6->log620 as $log620)
                                        <div class="form-group col-sm-5 mt-2">
                                            <div class="row py-1">
                                                <div style="width:96%">
                                                    <input type="hidden" name="log620_id[]" value="{{ $log620->id }}">
                                        ...
                                        <div class="form-group col-sm-2 mt-2">
                                            @if($chkAllowAccess || in_array($userOfficerID, $arrOfficerIDs) || auth()->user()->id == $row->user_created)
                                            @php
                                                $deleteUrl = url('log6/delete/log620/'.$log620->id.'_'.$log6->id);
                                                    $onClick = "comfirm_delete_steetalert2('".$deleteUrl."','តើអ្នកពិតជាចង់លុប មែនឫ?')";
...
{{--                                            <input type="text" name="log620_solution[]" value="{{ old('log620_solution[]') }}" class="form-control">--}}
                                ...
                                <div class="form-group col-sm-1 mt-1">
                                    ...
                                    <button type="button" id="btn_add_log620" class="btn btn-info form-control">បន្ថែម</button>
                                </div>
                                <div class="form-group col-sm-1 mt-1">
                                    <label style="color:#FFFFFF">x</label>
                                    <button type="button" id="btn_remove_log620" class="btn btn-danger form-control">លុប</button>
                                </div>
                            </div>

                            <div class="row col-12 mt-3">
                                <label class="fw-bold mb-1">២១. ចំណុចមិនសះជារបស់គូភាគី <span class="text-danger">(ប្រសិនបើមាន សូមបំពេញទាំងចំណុចមិនសះជា និង ដំណោះស្រាយ)</span></label>
                            </div>
                            <div class="row mt-3">
                                <div class="form-group col-sm-5">
                                ...
                                @if($log6->log621->count() > 0)
                                    ...
                                    @foreach($log6->log621 as $log621)
                                        <div class="form-group col-sm-5 mt-3">
                                            <div class="row py-1">
                                                <div style="width:96%">
                                                    <input type="hidden" name="log621_id[]" value="{{ $log621->id }}">
                                        ...
                                        <div class="form-group col-sm-2 mt-4">
                                            @if($chkAllowAccess || in_array($userOfficerID, $arrOfficerIDs) || auth()->user()->id == $row->user_created)
                                            @php
                                                $deleteUrl = url('log6/delete/log621/'.$log621->id.'_'.$log6->id);
                                                    $onClick = "comfirm_delete_steetalert2('".$deleteUrl."','តើអ្នកពិតជាចង់លុប មែនឫ?')";
                                                $str2='<button type="button" class="btn btn-danger" onClick="'.$onClick.'" title="Delete"><i data-feather="trash"></i></button>';
                                                echo $str2;
                                            @endphp
                            ...
                            <div id="log621_1" class="row">
                                ...
                                <div class="form-group col-sm-1 mt-1">
                                    <label style="color:#FFFFFF">x</label>
                                    <button type="button" id="btn_add_log621" class="btn btn-info form-control">បន្ថែម</button>
                                </div>
                                <div class="form-group col-sm-1 mt-1">
                                    <label style="color:#FFFFFF">x</label>
                                    <button type="button" id="btn_remove_log621" class="btn btn-danger form-control">លុប</button>
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="form-group col-sm-4">
                                    ...
                                    <input type="text" name="translator" value="{{ old('translator', $log6->translator) }}" class="form-control" >
                                </div>
                                @if($chkAllowAccess || in_array($userOfficerID, $arrOfficerIDs) || auth()->user()->id == $row->user_created)
                                <div class="form-group col-sm-8">
                                    <label class="fw-bold mb-1">លិខិតផ្ទេរសិទ្ធិ</label>
{{--                                            {!! upload_file("case_file", "(ប្រភេទឯកសារ pdf មានទំហំធំបំផុត 5MB)") !!}--}}
                                    <input type="hidden" name="translator_letter_old" value="{{ $log6->translator_letter }}" >
                                    @php
                                        $show_file = showFile(1, $log6->translator_letter, pathToDeleteFile('case_doc/log6/'.$caseYear."/"), "delete", "tbl_case_log6", "log_id", $log6->log_id,  "translator_letter");
                                        if($show_file){
                                            echo "<br><div class='mt-1'>".$show_file."</div>";
                                        }
                                        else{
                                            echo "<div class='py-1'>".upload_file("translator_letter", "(ប្រភេទឯកសារ pdf មានទំហំធំបំផុត 5MB)")."</div>";
                                        }
                                    @endphp
                                </div>
                                @endif
                            ...
                            <div class="row">
                                <div class="form-group col-sm-9 mt-3">
                                    ...
                                    {!! showSelect('log624_cause_id', arrayLog624(1, ""), old('log624_cause_id', $log6->log624_cause_id), " select2", "", "", "") !!}
                                </div>
                                <div class="form-group col-sm-3 mt-3">
                                    <label class="fw-bold mb-1">បើសិនជ្រើសរើស (បញ្ហាដទៃទៀត) </label>
                                    <input type="text" name="log624_cause_other" value="{{ old('log624_cause_other', $log6->log624_cause_other) }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-9 mt-3">
                                    ...
                                    {!! showSelect('log625_solution_id', arrayLog625(1, ""), old('log625_solution_id', $log6->log625_solution_id), " select2", "", "", "") !!}
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-10" style="text-align: center;">
                                    <div class="m-t-20 m-checkbox-inline custom-radio-ml">
                                        ...
                                        <div class="form-check form-check-inline radio radio-primary">
                                            <input  class="form-check-input radio_status_id" id="status{{ $key }}" type="radio" name="radio_status_id" value="{{ $key }}" @if($log6->status_id == $key) checked @endif >
...
{{--                                </div>--}}
                                <div id="show_upload_status_letter" class="row">
                                    <div class="form-group col-sm-3">
                                        ...
                                        <input type="text" name="status_date" id="status_date" value="{{ old('status_date', date2Display($log6->status_date)) }}" class="form-control"  data-language="en" >
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <label class="fw-bold">ម៉ោង</label>
                                        <div class="input-group clockpicker" data-autoclose="true">
                                            <input name="status_time" id="status_time" value="{{ old('status_time', date2Display($log6->status_time, "H:i")) }}" class="form-control" type="text" data-bs-original-title="" required >
                                        </div>
                                    </div>
                                    @if($chkAllowAccess || in_array($userOfficerID, $arrOfficerIDs) || auth()->user()->id == $row->user_created)
                                    <div class="form-group col-sm-6">
                                        <label class="fw-bold">លិខិតសុំផ្សះផ្សាឡើងវិញ</label>
                                        <input type="hidden" name="status_letter_old" value="{{ $log6->status_letter }}" >
                                        @php
                                            $show_file= showFile(1, $log6->status_letter, pathToDeleteFile('case_doc/log6/status_letter/'.$caseYear."/"), "delete", "tbl_case_log6", "log_id", $log6->log_id,  "status_letter");
                                            if($show_file){
                                                echo "<br><div class='mt-1'>".$show_file."</div>";
                                            }
                                            else{
                                                echo "<div class='py-1'>".upload_file("status_letter", "(ប្រភេទឯកសារ pdf មានទំហំធំបំផុត 5MB)")."</div>";
                                            }
                                        @endphp
                                    </div>
                                    @endif
