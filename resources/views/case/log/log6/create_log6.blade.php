...
<x-admin.layout-main :adata="$adata" >
    ...
    <div class="container-fluid">
        <div class="row starter-main">
            <div class="col-sm-12">
                <div class="card">
                    <form name="formCreateCase" action="{{ url('log6') }}" method="POST" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="card-body text-hanuman-17">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6 mt-3">
                                    <label class="fw-bold mb-1 required">១. កាលបរិចេ្ឆទនៃការចាប់ផ្ដើមវិវាទរវាងគូភាគី</label>
                                    <input type="text"  value="{{ old('meeting_date', date2Display($row->case_date)) }}" class="form-control"  data-language="en" disabled >
                                </div>
                                <div class="form-group col-sm-6 mt-3">
                                    <label class="fw-bold mb-1 required">២. កាលបរិចេ្ឆទនៃវិវាទដែលបានប្ដឹងទៅអធិការការងារ</label>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 mt-3">
                                    <label for="case_type" class="pink text-hanuman-18 fw-bold mb-1"> ស្វែងរកឈ្មោះអ្នកអមកម្មករ</label>
                            ...
                            <div id="r1Company" class="row" style="display: none">
                                ...
                                <div class="form-group col-sm-2 mt-3">
                                    <label class="fw-bold mb-1">ផ្លូវ</label>
                                    <input type="text" value="{{ $row->caseCompany->log5_head_street_no }}" class="form-control" disabled />
                                </div>
                                <div class="form-group col-sm-2 mt-3">
                                    <label class="fw-bold mb-1">ភូមិ</label>
                                    <input type="text" value="@if(!empty($row->caseCompany->village)) {{ $row->caseCompany->village->vil_khname }} @endif" class="form-control" disabled />
                                </div>
                                <div class="form-group col-sm-2 mt-3">
                                    <label class="fw-bold mb-1">ឃុំ-សង្កាត់</label>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 mt-3">
                                    <label for="case_type" class="pink fw-bold text-hanuman-18 mb-1"> ស្វែងរកឈ្មោះតំណាងនិយោជក</label>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 mt-3">
                                    <label for="case_type" class="fw-bold pink text-hanuman-18 mb-1"> ស្វែងរកឈ្មោះអ្នកអមនិយោជក</label>
