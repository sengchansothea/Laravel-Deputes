                        ...
                        <form name="uploadFile" action="{{ $adata['url'] }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" name="status_date" id="status_date" value="{{ date2Display($log6->status_date) }}" class="form-control" data-language="en" required >
                                </div>
                                <div class="form-group col-sm-6">
                                    <label class="fw-bold mb-1">ម៉ោង</label>
                                    <div class="input-group clockpicker" data-autoclose="true">
                                        <input name="status_time" id="status_time" value="{{ date2Display($log6->status_time, 'H:i') }}" class="form-control" type="text" data-bs-original-title="" required >
                                    </div>
                                </div>
...
{{--                                </div>--}}
                                <div class="form-group col-sm-6 mt-4">
                                    <button type="submit" class="btn btn-success form-control fw-bold">កែប្រែ</button>
                                </div>
                                @php
