...
{{--        Select2 Css--}}
    ...
    <div class="container-fluid">
        <div class="row starter-main">
            <div class="col-sm-12">
                <div class="card">
                    <form name="formCreateCase" action="{{ url('log5') }}" method="POST" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
...
{{--                                        </div>--}}
                                    ...
                                    <div class="row col-12">
                                        ...
                                        <div class="form-group col-sm-9 mt-3">
                                            ...
                                            <input type="text" name="meeting_about" value="ពាក្យបណ្ដឹងរបស់ {{ $preGender." ".$row->disputant->name." ".$meetingAbout }}" id="meeting_about" class="form-control" required />
                                        </div>
                                    </div>
...
{{--                                            {!! showSelect('noter', arrayOfficerExcept($officerId, 1, ""), old('noter'), " select2", "", "", "required") !!}--}}
                                    ...
                                    <div class="row col-12">
                                        <div class="form-group col-sm-12 mt-3">
                                            <label class="fw-bold mb-1 pink" for="contact_phone">យោបល់របស់ប្រធានអង្គប្រជុំ</label>
                                    ...
                                    <div class="row col-12">
                                        ...
                                        <div class="form-group col-sm-4 mt-3">
                                            ...
                                            <input type="text"  name="log5_open_date" id="open_date" value="{{ old('open_date', date2Display($row->company->open_date)) }}" class="form-control"  data-language="en">
                                        </div>
                                        <div class="form-group col-sm-3 mt-3">
                                            <label class="fw-bold mb-1">កាលបរិច្ឆេទចុះបញ្ជីពាណិជ្ជកម្ម</label>
                                            <input type="text"  name="registration_date" id="registration_date" value="{{ old('registration_date', date2Display($row->company->registration_date)) }}" class="form-control"  data-language="en">
                                        </div>
                                        <div class="form-group col-sm-3 mt-3">
                                            <label class="fw-bold mb-1">លេខចុះបញ្ជីពាណិជ្ជកម្ម</label>
                                            <input type="text"  name="company_register_number" id="company_register_number" value="{{ old('company_register_number', $row->company->company_register_number) }}" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-3 mt-3">
                                            <label class="fw-bold mb-1">លេខអត្តសញ្ញាណ ប.ស.ស.</label>
                                            <input type="text"  name="nssf_number" id="nssf_number" value="{{ old('nssf_number', $row->company->nssf_number) }}" class="form-control">
                                        </div>
                                        <div class="form-group col-sm-3 mt-3">
                                            <label class="fw-bold mb-1">លេខអត្តសញ្ញាណកម្មសារពើពន្ធ (TIN)</label>
                                            <input type="text"  name="company_tin" id="company_tin" value="{{ old('company_tin', $row->company->company_tin) }}" class="form-control">
                                        </div>
                                    ...
                                    <div class="row col-12">
                                        <div class="form-group col-sm-6 mt-3">
                                            <label class="fw-bold required text-primary mb-1">អាសយដ្ឋាននៃមន្ទីរចាត់ការសហគ្រាស រាជធានី-ខេត្ត</label>
                                        ...
                                        <div class="form-group col-sm-3 mt-3">
                                            <label class="fw-bold mb-1">ផ្លូវ</label>
                                            <input type="text" name="log5_head_street_no" id="log5_head_street_no" value="{{ old('log5_head_street_no', $row->company->street_no) }}" class="form-control" />
                                        </div>
                                        <div class="form-group col-sm-3 mt-3">
                                            <label class="fw-bold mb-1">អគារលេខ</label>
                                            <input type="text" name="log5_head_building_no" id="log5_head_building_no" value="{{ old('log5_head_building_no', $row->company->building_no) }}" class="form-control" />
                                        </div>
                                        <div class="form-group col-sm-3 mt-3">
                                            <label class="fw-bold mb-1">លេខទូរស័ព្ទ</label>
                                            <input type="text" name="log5_head_phone" value="{{ old('log5_head_phone', $row->company->company_phone_number) }}" class="form-control" id="log5_head_phone" placeholder="">
                                        </div>
                                    ...
                                    <div class="row col-12 mt-3">
                                        <div class="form-group col-sm-6 mt-3">
                                            ...
                                            <input type="text" name="log5_first_business_act" value="{{ old('log5_first_business_act', $row->company->first_business_act) }}" class="form-control" id="log5_first_business_act" placeholder="">
                                        </div>
                                        <div class="form-group col-sm-6 mt-3">
                                            <label class="fw-bold mb-1 required">ទ្រង់ទ្រាយសហគ្រាស</label>
                                            {!! showSelect('log5_article_of_company', arrayArticleOfCompany(1,0), old('log5_article_of_company', $row->company->article_of_company), " select2") !!}
                                        </div>
                                        <div class="form-group col-sm-6 mt-3">
                                            <label class="fw-bold mb-1 required">ប្រភេទសហគ្រាស</label>
                                            {!! showSelect('log5_company_type_id', arrayCompanyType(1,0), old('log5_company_type_id', $row->company->company_type_id), " select2") !!}
                                        </div>
                                        <div class="form-group col-sm-6 mt-3">
                                            <label class="fw-bold mb-1 required">វិស័យ</label>
                                            {!! showSelect('log5_sector_id', myArraySector(1,0), old('log5_sector_id', $row->company->sector_id), " select2") !!}
                                        </div>
...
//                                            $arrayBus4 = $business_activity4 > 0? arrayBusinessActivity4($business_activity1, $business_activity2, $business_activity3, 1, ""): array();
                                        ...
                                        <input type="hidden" name="log5_business_activity" value="{{ $row->company->business_activity }}" >
...
{{--                                    Address Of Company--}}
                                    <div class="row col-12 mt-3">
                                        ...
                                        <div class="form-group col-sm-4 mt-3">
                                            <label class="fw-bold mb-1">ផ្លូវ</label>
                                            <input type="text" name="log5_street_no" id="log5_street_no" value="{{ old('log5_street_no', $row->company->street_no) }}" class="form-control" />
                                        </div>
                                        <div class="form-group col-sm-4 mt-3">
                                            <label class="fw-bold mb-1">អគារលេខ</label>
                                            <input type="text" name="log5_building_no" id="log5_building_no" value="{{ old('log5_head_building_no', $row->company->building_no) }}" class="form-control" />
                                        </div>
                                        <div class="form-group col-sm-4 mt-3">
                                            <label class="fw-bold mb-1">លេខទូរស័ព្ទ</label>
                                            <input type="text" name="log5_company_phone_number" value="{{ old('log5_company_phone_number', $row->company->company_phone_number) }}" class="form-control" id="log5_company_phone_number" placeholder="">
                                        </div>
                                    ...
                                    <div class="row col-12">
                                        <div class="form-group col-sm-12 mt-3">
                                            <label class="fw-bold mb-1 pink" for="contract_type_with_employee">-ប្រភេទនៃកិច្ចសន្យាការងារដែលបានចុះជាមួយកម្មករនិយោជិត</label>
                                            {!! showTextarea("contract_type_with_employee", old('contract_type_with_employee')) !!}
                                        </div>
                                    </div>
                                    <div class="row col-12">
                                        <div class="form-group col-sm-12 mt-3">
                                            <label class="text-purple text-hanuman-24 mb-1" for="dispute_cause">ខ. អង្គហេតុចម្បងនៃវិវាទ</label>
                                            {!! showTextarea("dispute_cause", old('dispute_cause'), 6) !!}
                                        </div>
                                    </div>
                                    <div class="row col-12">
                                        <div class="form-group col-sm-12 mt-3">
                                            <label class="text-purple text-hanuman-24 mb-1" for="dispute_more_info">គ. ព័ត៌មានបន្ថែម</label>
