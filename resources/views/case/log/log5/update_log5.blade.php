        ...
        <div class="row starter-main">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body row mt-2">
                        <div class="form-group col-sm-4">
                            <a class="btn btn-info custom form-control fw-bold"
                                href="{{ url('export/word/case/log5/' . $log5->id) }}" title="Download"
                        ...
                        @if (
                            $chkAllowAccess ||
                                in_array($userOfficerID, $arrOfficerIDs) ||
                                (auth()->user()->id == $row->user_created && count($row->invitationForConcilation) == 0))
                            <div class="form-group col-sm-4">
                    ...
                    <form name="formCreateCase" action="{{ url('log5/' . $log5->id) }}" method="POST"
                        ...
                        <div class="card-body text-hanuman-17">
                            ...
                            <div id="plantiff_block">
                                <div class="row col-12 mt-3">
                                    <span class="text-info text-hanuman-24">ព័ត៌មានសង្ខេបពីសហគ្រាស គ្រឹះស្ថាន</span>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        <input type="text" value="{{ $row->company->company_register_number }}"
                                            class="form-control" disabled />
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        <input type="text" name="meeting_date" id="meeting_date"
                                            value="{{ old('meeting_date', date2Display($log5->meeting_date)) }}"
                                    ...
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        <div class="input-group clockpicker" data-autoclose="true">
                                            <input name="meeting_stime" id="meeting_stime"
                                                value="{{ old('meeting_stime', date2Display($log5->meeting_stime, 'H:i')) }}"
                                    ...
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        <div class="input-group clockpicker" data-autoclose="true">
                                            <input name="meeting_etime" id="meeting_etime"
                                                value="{{ old('meeting_etime', date2Display($log5->meeting_etime, 'H:i')) }}"
                                                class="form-control" type="text" data-bs-original-title=""
                                                required>
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        {!! showSelect(
                                            ...
                                            old('meeting_place_id', $log5->meeting_place_id),
                                            ' select2',
                                            '',
                                            '',
                                            '',
                                    ...
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        <input type="text" name="meeting_place_other"
                                            value="{{ old('meeting_place_other', $log5->meeting_place_other) }}"
                                            class="form-control">
                                    </div>

                                    <div class="form-group col-sm-9 mt-3">
                                        <label class="fw-bold mb-1 required">អំពីបញ្ហា</label>
                                        <input type="text" name="meeting_about" id="meeting_about"
                                            value="{{ old('meeting_about', $log5->meeting_about) }}"
                                ...
                                @php
                                    ...
                                    $officerNoter = !empty($adata['noter']->attendant_id)
                                        ? $adata['noter']->attendant_id
                                        : getCaseOfficer($row->id, 1, 8);
                                        ...
                                        <div class="form-group col-sm-3 mt-4">
                                            <label class="fw-bold mb-1">
                                                ...
                                                @if ($chkAllowAccess || in_array($userOfficerID, $arrOfficerIDs) || auth()->user()->id == $row->user_created)
                                                    @php
                                                        $deleteUrl = url(
                                                            'log5/delete/represent_company/' .
                                                                $adata['represent_company']->id .
                                                                '_' .
                                                                $log5->id,
                                                        );
                                                        $onClick =
                                            ...
                                            <input type="text"
                                                value="{{ $adata['represent_company']->disputant->name }}"
                                                class="form-control" disabled />
                                        </div>
                                    @else
                                        <div class="form-group col-sm-3 mt-4">
                                    ...
                                    @if ($adata['sub_represent_company']->count() > 0)
                                        @foreach ($adata['sub_represent_company'] as $subCompany)
                                            <div class="form-group col-sm-3 mt-4">
                                                ...
                                                <input type="text" value="{{ $subCompany->disputant->name }}"
                                                    class="form-control" disabled />
                                            </div>
                                        @endforeach
                                    @endif
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        <input type="text" name="dob[]" id="represent_company_dob"
                                            value="{{ old('dob[]') }}" class="form-control" data-language="en">
                                    </div>
                                    <div class="form-group col-sm-3 mt-3">
                                    ...
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        <input type="text" name="id_number[]" value="{{ old('id_number[]') }}"
                                            class="form-control" id="represent_company_id_number">
                                    </div>
                                    <div class="form-group col-sm-3 mt-3">
                                        <label for="phone_number"
                                            class="required2 fw-bold mb-1">លេខទូរស័ព្ទខ្សែទី១</label>
                                        <input type="text" name="phone_number[]"
                                            id="represent_company_phone_number" value="{{ old('phone_number[]') }}"
                                            class="form-control">
                                    </div>
                                    <div class="form-group col-sm-3 mt-3">
                                        <label for="phone_number" class="fw-bold mb-1">លេខទូរស័ព្ទខ្សែទី២</label>
                                        <input type="text" name="phone2_number[]"
                                            id="represent_company_phone2_number" value="{{ old('phone2_number[]') }}"
                                            class="form-control">
                                    </div>
                                    <div class="form-group col-sm-3 mt-3">
                                        <label class="fw-bold mb-1 required2" for="occupation">មុខងារ</label>
                                        <input type="text" name="occupation[]" id="represent_company_occupation"
                                    ...
                                    <div class="form-group col-sm-4 mt-3">
                                        ...
                                        <input type="text" name="addr_house_no[]"
                                            id="represent_company_addr_house_no" value="{{ old('addr_house_no') }}"
                                            class="form-control">
                                    </div>
                                    <div class="form-group col-sm-4 mt-3">
                                        <label class="fw-bold mb-1">ផ្លូវ</label>
                                        <input type="text" name="addr_street[]" id="represent_company_addr_street"
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12 mt-3">
                                        <label for="contact_phone"
                                            class="fw-bold mb-1">យោបល់របស់ប្រធានអង្គប្រជុំ</label>
                            ...
                            <div id="contract_block" style="display: none;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-4 mt-3">
                                        ...
                                        <input type="text" name="log5_open_date" id="open_date"
                                            value="{{ old('open_date', date2Display($company->open_date)) }}"
                                    ...
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        <input type="text" name="registration_date" id="registration_date"
                                            value="{{ old('registration_date', date2Display($company->registration_date)) }}"
                                            class="form-control" data-language="en">
                                    </div>
                                    <div class="form-group col-sm-2 mt-3">
                                        <label class="fw-bold mb-1">លេខចុះបញ្ជីពាណិជ្ជកម្ម</label>
                                ...
                                @php
                                    ...
                                    $arrayHeadDistrict = $head_district > 0 ? arrayDistrict($head_province, 1, '') : [];
                                    $arrayHeadCommune = $head_commune > 0 ? arrayCommune($head_district, 1, '') : [];
                                    $arrayHeadVillage = $head_village > 0 ? arrayVillage($head_commune, 1, '') : [];
                                @endphp
                                <div class="row">
                                    <div class="form-group col-sm-5 mt-3">
                                        <label
                                            class="fw-bold mb-1 required text-primary">អាសយដ្ឋាននៃមន្ទីរចាត់ការសហគ្រាស
                                            រាជធានី-ខេត្ត</label>
                                        {!! showSelect(
                                            'log5_head_province_id',
                                            arrayProvince(1, 0),
                                            old('log5_head_province_id', $head_province),
                                            ' select2',
                                        ) !!}
                                    </div>
                                    <div class="form-group col-sm-4 mt-3">
                                        ...
                                        {!! showSelect(
                                            ...
                                            $arrayHeadDistrict,
                                            old('log5_head_district_id', $head_district),
                                            ' select2',
                                            '',
                                            '',
                                            'required',
                                    ...
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        {!! showSelect(
                                            ...
                                            $arrayHeadCommune,
                                            old('log5_head_commune_id', $head_commune),
                                            ' select2',
                                            '',
                                            '',
                                            'required',
                                    ...
                                    <div class="form-group col-sm-3 mt-3">
                                        <label class="fw-bold mb-1">ភូមិ</label>
                                        {!! showSelect(
                                            'log5_head_village_id',
                                            $arrayHeadVillage,
                                            old('log5_head_village_id', $head_village),
                                            ' select2',
                                        ) !!}
                                    </div>
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        <input type="text" name="log5_head_street_no" id="log5_head_street_no"
                                            value="{{ old('log5_head_street_no', $caseCompany->log5_head_street_no) }}"
                                            class="form-control" />
                                    </div>
                                    <div class="form-group col-sm-3 mt-3">
                                        <label class="fw-bold mb-1">អគារលេខ</label>
                                        <input type="text" name="log5_head_building_no" id="log5_head_building_no"
                                            value="{{ old('log5_head_building_no', $caseCompany->log5_head_building_no) }}"
                                            class="form-control" />
                                    </div>
                                    <div class="form-group col-sm-3 mt-3">
                                        <label class="fw-bold mb-1">លេខទូរស័ព្ទ</label>
                                        <input type="text" name="log5_head_phone"
                                            value="{{ old('log5_head_phone', $caseCompany->log5_head_phone) }}"
                                    ...
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        <input type="text" name="log5_owner_name_khmer"
                                            value="{{ old('log5_owner_name_khmer', $caseCompany->log5_owner_name_khmer) }}"
                                            class="form-control" id="log5_owner_name_khmer" placeholder="">
                                    </div>
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        {!! showSelect(
                                            ...
                                            old('log5_owner_nationality_id', $caseCompany->log5_owner_nationality_id),
                                            ' select2',
                                        ) !!}
                                    </div>
                                    ...
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        <input type="text" name="log5_director_name_khmer"
                                            value="{{ old('log5_director_name_khmer', $caseCompany->log5_director_name_khmer) }}"
                                            class="form-control" id="log5_director_name_khmer" placeholder="">
                                    </div>
                                    <div class="form-group col-sm-3 mt-3">
                                        <label class="fw-bold mb-1">សញ្ជាតិ</label>
                                        {!! showSelect(
                                            ...
                                            arrayNationality(1, 0),
                                            old('log5_director_nationality_id', $caseCompany->log5_director_nationality_id),
                                            ' select2',
                                        ) !!}
                                    </div>
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        <input type="text" name="log5_first_business_act"
                                            value="{{ old('log5_first_business_act', $caseCompany->log5_first_business_act) }}"
                                    ...
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        {!! showSelect(
                                            ...
                                            old('log5_article_of_company', $caseCompany->log5_article_of_company),
                                            ' select2',
                                        ) !!}
                                    </div>
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        {!! showSelect(
                                            ...
                                            old('log5_company_type_id', $caseCompany->log5_company_type_id),
                                            ' select2',
                                        ) !!}
                                    </div>
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        {!! showSelect(
                                            'log5_sector_id',
                                            myArraySector(1, 0),
                                            old('log5_sector_id', $caseCompany->log5_sector_id),
                                            ' select2',
                                        ) !!}
                                    </div>
                                </div>
                                ...
                                @php
                                    ...
                                    $arrayDistrict = $head_district > 0 ? arrayDistrict($province_id, 1, '') : [];
                                    $arrayCommune = $head_commune > 0 ? arrayCommune($district_id, 1, '') : [];
                                    $arrayVillage = $head_village > 0 ? arrayVillage($commune_id, 1, '') : [];
                                @endphp
                                <div class="row mt-3">
                                    <div class="form-group col-sm-3 mt-3">
                                    ...
                                    <div class="form-group col-sm-1 mt-3">
                                        ...
                                        <input type="text" name="log5_street_no" id="log5_street_no"
                                            value="{{ old('log5_street_no', $caseCompany->log5_street_no) }}"
                                            class="form-control" />
                                    </div>
                                    <div class="form-group col-sm-2 mt-3">
                                        <label class="fw-bold mb-1">អគារលេខ</label>
                                        <input type="text" name="log5_building_no" id="log5_building_no"
                                            value="{{ old('log5_building_no', $caseCompany->log5_building_no) }}"
                                            class="form-control" />
                                    </div>
                                    <div class="form-group col-sm-2 mt-3">
                                        <label class="fw-bold mb-1">លេខទូរស័ព្ទ</label>
                                        <input type="text" name="log5_company_phone_number"
                                            value="{{ old('log5_company_phone_number', $caseCompany->log5_company_phone_number) }}"
                                    ...
                                    <div class="form-group col-sm-2 mt-3">
                                        ...
                                        <input type="number" min="0" name="log5_total_employee"
                                            value="{{ old('log5_total_employee', $caseCompany->log5_total_employee) }}"
                                            class="form-control" id="log5_total_employee" placeholder="">
                                    </div>
                                    <div class="form-group col-sm-2 mt-3">
                                        <label class="fw-bold mb-1">ស្រី</label>
                                        <input type="number" min="0" name="log5_total_employee_female"
                                            value="{{ old('log5_total_employee_female', $caseCompany->log5_total_employee_female) }}"
                                    ...
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        <input type="number" min="0" name="log5_union1_number"
                                            value="{{ old('log5_union1_number', $caseCompany->log5_union1_number) }}"
                                            class="form-control" id="log5_union1_number">
                                    </div>
                                </div>
                                        ...
                                        @foreach ($log5->union1 as $union1)
                                            <div class="form-group col-sm-6 mt-3">
                                                <div class="row py-1">
                                                    ...
                                                    <div style="width:96%">
                                                        <input type="hidden" name="union1_id[]"
                                                            value="{{ $union1->id }}">
                                                        <input type="text" name="union1_name_update[]"
                                                            value="{{ old('union1_name_update[]', $union1->union1_name) }}"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group col-sm-6 mt-4">
                                                @if ($chkAllowAccess || in_array($userOfficerID, $arrOfficerIDs) || auth()->user()->id == $row->user_created)
                                                    @php
                                                        $deleteUrl = url(
                                                            'log5/delete/union1/' . $union1->id . '_' . $log5->id,
                                                        );
                                                        $onClick =
                                                            "comfirm_delete_steetalert2('" .
                                                            $deleteUrl .
                                ...
                                <div id="union_1" class="row">
                                    ...
                                    <div class="form-group col-sm-3 mt-3">
                                        ...
                                        <button type="button" id="btn_add_union"
                                            class="btn btn-info form-control fw-bold">បន្ថែមឈ្មោះសហជីពមូលដ្ឋាន</button>
                                    </div>
                                    <div class="form-group col-sm-3 mt-3">
                                        <label style="color:#FFFFFF">x</label>
                                        <button type="button" id="btn_remove_union"
                                            class="btn btn-danger form-control fw-bold">លុបឈ្មោះសហជីពមូលដ្ឋាន</button>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12 mt-3">
                                        <label class="fw-bold mb-1 pink"
                                            for="contact_phone">-ប្រភេទនៃកិច្ចសន្យាការងារដែលបានចុះជាមួយកម្មករនិយោជិត</label>
                                        {!! showTextarea(
                                            'contract_type_with_employee',
                                            old('contract_type_with_employee', $log5->contract_type_with_employee),
                                        ) !!}
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12 mt-3">
                                        <label class="text-purple text-hanuman-24" for="contact_phone">ខ.
                                            មូលហេតុចម្បងនៃវិវាទ</label>
                                        {!! showTextarea('dispute_cause', old('dispute_cause', $log5->dispute_cause), 6) !!}
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12 mt-3">
                                        <label class="text-purple text-hanuman-24" for="contact_phone">គ.
                                            ព័ត៌មានបន្ថែម</label>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="form-group col-sm-3">
                                            <button type="submit" name="btnSubmit" value="save"
                                                class="form-control btn btn-success fw-bold">{{ __('btn.button_save') }}</button>

                                        </div>
                                        <div class="form-group col-sm-4">
                                            <button type="submit" name="btnSubmit" value="next"
                                                class="form-control btn btn-success fw-bold">{{ __('btn.button_save2') }}</button>
                                        </div>
                                    </div>
                                @endif
                            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (btnNext) {
                btnNext.addEventListener('click', function() {
                    ...
                    // scroll to top of contract block
            ...
            if (btnBack) {
                btnBack.addEventListener('click', function() {
                    ...
                    // scroll to top of plantiff block
