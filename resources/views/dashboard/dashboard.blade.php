        ...
        <div class="row starter-main">
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body d-flex flex-wrap justify-content-between" style="padding: 15px 15px 0px 15px; gap: 15px;">
                                <div class="card flex-fill" style="min-width: 180px;">
                                    <div class="card-body text-center text-white" style="border-radius: 5px; background-color: deeppink">
                                        <img src="../assets/images/bitcoin/1.png" alt="">
                                        <h6 class="fw-bold" style="font-size: 20px">សរុប</h6>
                                        <h5 class="fw-bold" style="font-size: 26px">{{ $totalCasesType1 }}</h5>
                                    </div>
                                </div>
                                <div class="card flex-fill" style="min-width: 180px;">
                                    <div class="card-body bg-success text-center text-white" style="border-radius: 5px;">
                                        <img src="../assets/images/bitcoin/1.png" alt="">
                                        <h6 class="fw-bold" style="font-size: 20px">បញ្ចប់</h6>
                                        <h5 class="counter fw-bold" style="font-size: 26px">{{ $totalResolved }} <i data-feather="lock"></i></h5>
                                    </div>
                                </div>
                                <div class="card flex-fill" style="min-width: 180px;">
                                    <div class="card-body bg-warning text-center text-white" style="border-radius: 5px;">
                                        <img src="../assets/images/bitcoin/2.png" alt="">
                                        <h6 class="fw-bold" style="font-size: 20px">កំពុងដំណើរការ</h6>
                                        <h5 class="fw-bold" style="font-size: 26px">{{ $totalInProgress }}</h5>
{{--                                        <h5 class="counter fw-bold" style="font-size: 26px">{{ $totalInProgress }} <i data-feather="activity"></i></h5>--}}
                                    </div>
                                </div>
                                <div class="card flex-fill" style="min-width: 180px;">
                                    <div class="card-body bg-secondary text-center text-white" style="border-radius: 5px;">
                                        <img src="../assets/images/bitcoin/4.png" alt="">
                                        <h6 class="fw-bold" style="font-size: 20px">កំពុងដំណើរការក្នុងឆ្នាំនេះ</h6>
                                        <h5 class="counter fw-bold" style="font-size: 26px">{{ $totalInProgressCurrentYear }} <i data-feather="layers"></i></h5>
                                    </div>
                                </div>
                                <div class="card flex-fill" style="min-width: 180px;">
                                    <div class="card-body bg-danger text-center text-white" style="border-radius: 5px;">
                                        <img src="../assets/images/bitcoin/3.png" alt="">
                                        <h6 class="fw-bold" style="font-size: 20px">ថ្មីៗ</h6>
                                        <h5 class="counter fw-bold" style="font-size: 26px">{{ $totalNewCases }} <i data-feather="arrow-up"></i></h5>
                                    </div>
                                </div>
                                <div class="card flex-fill" style="min-width: 180px;">
                                    <div class="card-body bg-primary text-center text-white" style="border-radius: 5px;">
                                        <img src="../assets/images/bitcoin/3.png" alt="">
                                        <h6 class="fw-bold" style="font-size: 20px">ថ្ងៃនេះ</h6>
                                        <h5 class="counter fw-bold" style="font-size: 26px">{{ $todayCases }} <i data-feather="bell"></i></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
