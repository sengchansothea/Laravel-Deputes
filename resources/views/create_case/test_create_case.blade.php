...
<x-admin.layout-main :adata="$adata">
                        ...
                        <div class="card-body px-4 py-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="case_number" id="case_number"
                                            value="{{ old('case_number', $casePre) }}" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="plantiff_block">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="company_name_khmer"
                                                ...
                                                placeholder="វាយបញ្ចូលឈ្មោះក្រុមហ៊ុនជាភាសាខ្មែរ" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="street_no" id="street_no"
                                                value="{{ old('street_no') }}" class="form-control"
                                                placeholder="ផ្លូវ">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="company_phone_number" class="required">លេខទូរស័ព្ទ
                                                (ខ្សែទី១)</label>
                                            <input type="text" name="company_phone_number"
                                                id="company_phone_number" value="{{ old('company_phone_number') }}"
                                                class="form-control number_only" minlength="9" maxlength="10"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="company_phone_number2"
                                                id="company_phone_number2" value="{{ old('company_phone_number2') }}"
                                                class="form-control number_only" minlength="9" maxlength="10"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="find_employee_autocomplete"
                                                value="{{ old('find_employee_autocomplete') }}" class="form-control"
                                                id="find_employee_autocomplete"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" value="{{ old('name') }}"
                                                class="form-control" id="name" placeholder="គោត្តនាម នាម"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="occupation" value="{{ old('occupation') }}"
                                                class="form-control" id="occupation" placeholder="មុខងារបច្ចុប្បន្ន"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" name="phone_number"
                                                value="{{ old('phone_number') }}" class="form-control number_only"
                                                id="phone_number" minlength="9" maxlength="10"
                                                placeholder="012345678" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" name="phone_number2"
                                                value="{{ old('phone_number2') }}" class="form-control number_only"
                                                id="phone_number2" minlength="9" maxlength="10"
                                                placeholder="012345678">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="addr_house_no"
                                                ...
                                                id="addr_house_no" placeholder="ផ្ទះលេខ">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                            ...
                            <div id="objective_block" style="display: none">
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label
                                                for="terminated_contract_date">ថ្ងៃខែឆ្នាំផ្ដាច់កិច្ចសន្យាការងារ</label>
                                            <input type="text" name="terminated_contract_date"
                                                id="terminated_contract_date"
                                                value="{{ old('terminated_contract_date') }}" class="form-control"
                                                data-language="en" placeholder="DD-MM-YYYY">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            <div id="contract_block" style="display: none">
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="disputant_sdate_work"
                                                class="required">ថ្ងៃខែឆ្នាំចូលបម្រើការងារ</label>
                                            <input type="text" name="disputant_sdate_work"
                                                id="disputant_sdate_work" value="{{ old('disputant_sdate_work') }}"
                                                class="form-control" placeholder="DD-MM-YYYY" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="disputant_contract_type"
                                                class="required">ប្រភេទកិច្ចសន្យាការងារ</label>
                                            {!! showSelect(
                                ...
                                <div class="row g-4">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="disputant_work_hour_day"
                                                class="required">ម៉ោងធ្វើការ/ថ្ងៃ</label>
                                            <input type="number" step="0.01" name="disputant_work_hour_day"
                                                id="disputant_work_hour_day"
                                                value="{{ old('disputant_work_hour_day') }}"
                                                class="form-control number_only_d" placeholder="ម៉ោង" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="disputant_work_hour_week"
                                                class="required">ម៉ោងធ្វើការ/សប្ដាហ៍</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" name="disputant_salary"
                                                id="disputant_salary" value="{{ old('disputant_salary') }}"
                                                class="form-control number_only_d" placeholder="0.00">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="disputant_holiday_week"
                                                class="required">ការឈប់សម្រាកប្រចាំសប្ដាហ៍</label>
                                            {!! showSelect(
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="disputant_holiday_year" class="required">ថ្ងៃបុណ្យជាតិ
                                                និងឈប់សម្រាកប្រចាំឆ្នាំ</label>
                                            {!! showSelect(
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="case_date" id="case_date"
                                                value="{{ old('case_date') }}" class="form-control"
                                                placeholder="DD-MM-YYYY" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="case_date_entry"
                                                class="required">កាលបរិច្ឆេទប្តឹងទៅអធិការការងារ</label>
    ...
    <x-slot name="moreAfterScript">
        @include('create_case.test_case_script1')
    </x-slot>
</x-admin.layout-main>
