  ...
  if ($("#column-chart2").length > 0) {
    ...
    if ($("#bar-chart1").length > 0) {
        ...
        function drawBarChart() {
            var chartData = window.barChartData || [];
            ...
            chartData.forEach(item => {
                dataArray.push([item.name, item.density, item.color]);
            });
            ...
            var options = {
                title: "ស្ថានភាពបណ្តឹង (Density of Precious Metals, in g/cm³)",
                width: '100%',
                height: 400,
                bar: {groupWidth: "95%"},
