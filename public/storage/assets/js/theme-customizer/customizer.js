...
$(document).ready(function() {
    ...
    $('.main-layout li').on('click', function() {
        ...
        if(layout == 'rtl') {
            $("#bootstrap-file").attr("href", "../assets/css/bootstrap.rtl.min.css");
        } else {
            $("#bootstrap-file").attr("href", "../assets/css/bootstrap.css");
        }
    });
});
